...
5. `git add -A && git commit` each touched repo. 6. `git pull --rebase && git push` — code repos first, `.github` last. 7. Run `handoff_status.sh`, paste verbatim; done IFF it prints HANDOFF COMPLETE.
