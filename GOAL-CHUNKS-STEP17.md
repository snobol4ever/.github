...
> (one4all `a8a064a0`).  Phases 2 / 3 / 4 ✅ SEQUENCED 2026-05-10
...
> (114) + Prolog (135) under `--sm-run` with `SCRIP_EXPRS_AUDIT=1`
...
>        (Icon 271 + Raku 186 + Snocone 114 + Prolog 135) under `--sm-run`
