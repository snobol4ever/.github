...
## ⭐ LIVE CURSOR — 2026-08-12 s38 (Claude Sonnet 5). **NEXT RUNG: still L-3b STEP-0′ — see #5 below for the falsifying probe to run first.** Board: **3 PASS / 10 FAIL** (`len_nonterm` · `len_pure` · `lit_len`), unchanged. ZERO emitted-byte change s38 (attempted fix reverted — see below). FINDING-2026-08-12j.
