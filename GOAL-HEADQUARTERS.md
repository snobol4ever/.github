...
- [ ] **TSX-WIRE — open the detour (inline bytes become the output). 🔬 PREP DONE 2026-05-24k — architecture verified + green oracle recorded; implementation not started (correctly deferred — large surgical multi-session change, must begin with fresh context budget per RULES.md "no broken commits").**
