...
## Session State (2026-05-24l — TSX-WIRE STARTED: 3 sub-steps done — driver de-bypassed — insn_* 23→16 — GATE GREEN)

**one4all HEAD: `2e3b22b5`** ✅ GATE-PK 442/0/612 NEW=0 GONE=0. Three-section audit GREEN. Prolog BB honest 124/0/0. **This session — TSX-WIRE-1/-2/-3 (TSX-WIRE is far smaller than prep feared — see correction):**
