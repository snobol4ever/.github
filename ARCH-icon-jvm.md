# ARCH-icon-jvm.md — Icon × JVM: Milestone History and Reference

Deep reference for the Icon JVM emitter. Session notes → SESSIONS_ARCHIVE.md.
Operational §NOW → FRONTEND-ICON-JVM.md.
...
| M-IJ-SORT | `sort/sortf` | ✅ |
| M-IJ-ALT-VALUE | ALT relay passes actual values through | ✅ |
| M-IJ-CASE | `case E of { ... }` | ✅ |
...
| **M-IJ-JCON-HARNESS** | rung36 JCON oracle suite — all t01–t52 PASS | ❌ NEXT |
