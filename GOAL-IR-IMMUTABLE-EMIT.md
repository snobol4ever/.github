...
- [ ] **RESERVED-SET RECONCILE — census DONE (2026-07-02, whole-src grep excluding decl/name-table), Lon decides delete-vs-implement per enum:**
  ...
  | `IR_RESUME_VALUE` | 0 | ir_ResumeValue (gen_bc:551 — JCON's ToBy RESUME uses it) | **reservation SPENT (TO-SPLIT landed WITHOUT it, `7dd2baf7`):** the +16 frame-slot counter + a plain add on β covers JCON's ToBy resume; delete-vs-keep back to Lon |
