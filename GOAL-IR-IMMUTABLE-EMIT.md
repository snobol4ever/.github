...
## ⛔ ICNBENCH — GET `corpus/benchmarks/icon` RUNNING END-TO-END (SCOREBOARD 2026-07-03: oracle 10/10 · m3 **2/10** · m4 **2/10** = version + **micsum**; SCRIP `5c5697ab`+scantab, Claude Sonnet 5)
