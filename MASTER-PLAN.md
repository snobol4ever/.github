...
| I6 | sweep-free-rows-are-real (the standing umbrella; the D0 sweep of 76 DONE rows ran under it, CEO-174 — the former I24 line) | ceo | the standing ceo umbrella: every sitting runs the visibility census AND `util_ladder_walk.py`; the plan's tables are rewritten from the output (cadence widened 2026-09-01) |
