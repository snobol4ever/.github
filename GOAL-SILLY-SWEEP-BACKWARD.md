...
| TVALPL | 12125 | ✅ clean |
| COPY | 6438 | ✅ clean |
| CNVRT cluster | 6457–6674 | ⚠️ stub — CNVRT_fn/CODER_fn/CONVE_fn all return FAIL |
| DATE | 6675 | ✅ clean |
| DT/DTRTN/DTEXTN | 6684 | ✅ clean |
| DMP/DUMP cluster | 6699 | 🐛 fixed — DMPX+DMPV SUM YCL,YCL,XCL: used DMPSP.l instead of saved name-length |
| DMK/DMPK1 | 6747 | ✅ clean |
| DUPL/DUPL1 | 6784 | ✅ clean — redundant MLENCL check harmless dead code |
| OPSYN cluster | 6805–6920 | ⚠️ stub — OPSYN_fn returns FAIL; all internal labels unimplemented |
| RPLACE | 6928 | ✅ clean |
| REVERS | 6954 | ✅ clean |
| SIZE | 6969 | ✅ clean |
| SUBSTR | 6981 | 🐛 fixed — XCALL_XSUBSTR called with 3 args; len (D_A(ZPTR)) was missing |
| TIME | 7007 | 🐛 fixed — XCALL_MSTIME/XCALL_SBREAL set .f (flag byte) to R; should be 0 |
| SUCCPT | 12120 | ✅ clean |
