...
|---------|--------|------|----------------|
| **DYNAMIC BYRD BOX** | DYN-47 | one4all `df3e3dd` · corpus `2f2bbe3` | **M-LEX-1 broad regression**: 126p/52f vs baseline 169p/9f. DYN-48: MONITOR diff scrip-interp vs SPITBOL on failing tests to find lex.l token-stream divergence. Then M-PARSE-1. |
