...
| `rt_make_list` | 95 stale / **171 real** | AGG | `OUT:ICON-RTX:s216` — checked out s216 as RTX-8d-ICN (8-line body, `by_name_dispatch.c:4733`); reuses `SCRIP_RTX_ICNAGG`, no new gate. Count re-derived from `scrip --compile`, not inherited |
