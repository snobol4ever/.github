...
| `rt_proc_call_open_det` | **2,060,043** | **19/22** | 5,291 | ✅ `DONE:PL-RTX:s223` — asm landed, executes, **0 bails**; ⛔ perf NULL and **UNFALSIFIABLE** (census cannot grade the van Roy corpus) | **none** ✅ |
