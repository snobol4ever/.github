...
| **x-net** | SCRIP / .NET backend | TINY compiler, CIL output |
| **x-jvm** | SCRIP / JVM backend | TINY compiler, Jasmin/JVM output |
| **x-asm** | SCRIP / x86-64 ASM backend | TINY compiler, NASM output |
...
| Feature Area | SCRIP | snobol4jvm | snobol4dotnet | snobol4python | snobol4csharp |
|-------------|:---:|:---:|:---:|:---:|:---:|
