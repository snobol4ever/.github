...
- **SCRIP (TINY/native):** 106/106 ASM corpus passing. C backend (99/106, deprecated).
...
kernel using the SCRIP x64 backend as the execution engine.
...
|-----------|--------|---------|
| SCRIP ASM backend | Production | 106/106 |
| SCRIP NET backend | M-T2-NET complete | 110/110 |
| SCRIP JVM backend | STLIMIT sprint active | ~90% |
...
- Type 1 and Type 0: SCRIP only — no competitor
...
snobol4ever/SCRIP, covering all PLAN, STATUS, ARCH, DESIGN, DECISIONS, GRIDS,
