...
The key insight in SCRIP: the Byrd Box model is not just an execution model — it is a **code generation strategy**. Compile those four states to static gotos and you get goal-directed backtracking evaluation with zero dispatch overhead.
