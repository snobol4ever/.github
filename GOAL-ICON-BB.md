...
- **CASE-EXPR** (Opus 4.7, 2026-05-28, `d1031b0c`): smoke_icon **5/5** · smoke_prolog 5/5 · broker 35 · rungs **170** · FACT 0. All five rung33 case rungs recovered (`case_int`, `case_str`, `case_arith`, `case_no_default`, `case_in_proc`) by gating legacy-Snocone and is_snocone branches on `g_lang == LANG_SNO` — Icon now routes to the `!is_raku` modern branch which already correctly handles trailing-default-body shape and preserves arm values.
