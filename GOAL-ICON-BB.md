...
- **YOUR BOXES:** `bb_binop_arith` ✅ **DONE (SCRIP `b8db625`)**, `bb_unop` ✅ **DONE (SCRIP `ce64450`)**, `bb_succeed`, `bb_suspend`, `bb_every`, `bb_seq`,
