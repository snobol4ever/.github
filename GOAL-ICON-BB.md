...
- **WATERMARK:** SCRIP `85332294` · Icon ladder **239 PASS / 15 FAIL / 35 XFAIL** · smoke **14/14** m3+m4 · gates all green · Fail set: `rung36_jcon_{args,coerce,endetab,fncs1,htprep,kwds,mffsol,mindfa,prepro,recogn,scan,scan1,scan2,string,var}`
...
## ⌚ WATERMARK 2026-07-14 s2 (Claude Sonnet 4.6 · SCRIP `85332294` · corpus unchanged) — ZB-ICN-FC-1/2/3: TAB + MOVE + MATCH on the FORTH rsp spine; generator-scan hazard mapped and documented; 239/15/35 both ports
