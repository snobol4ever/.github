**WATERMARK: SCRIP `8d9b8d50` · Icon suite PASS=236 FAIL=25 XFAIL=32 / 293 · RT_OPT=-O0 · SNOBOL4 crosscheck 221/219 FAIL=94 DIVERGE=1 UNCHANGED. ⚠ The s169 `e63a8b6a` watermark of 250/11/32 was SILENTLY FALSIFIED by the parallel SNOBOL4 FLATDISP ladder (s186-s195); 236 is a partial recovery from the 199 that HEAD had actually degraded to.**

## ▶ LIVE CURSOR (s196, 2026-07-27)
