...
**HEAD (SCRIP) = `416a868` — LOWER-ICON STANDALONE WIP BROKEN 2026-06-06. m2 10 · m3 5 · m4 5. HEAD (.github) = HANDOFF-2026-06-06-SONNET46-LOWER-ICON-STANDALONE.md.**
Session 2026-06-06 (Sonnet 4.6, lower_icon.c split WIP): Pivoted from BUG-1..6 to Lon directive: standalone lower_icon.c. File created with Icon-exclusive helpers + lower2_icn; lower.c stripped of inline ICN arms. Two bugs block gates: (1) icn_subgraph wrong structure m3/m4 total collapse — fix: use lower_value_subgraph; (2) TT_EVERY wiring m2 -1 — fix: remove TT_EVERY from lower2_icn. Fixes documented in handoff. BUG-1..6 still open.
