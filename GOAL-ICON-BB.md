...
- **PARAM-SHADOW** (Opus 4.7, 2026-05-28, `d35fdb1e`): rungs **171** · broker 35 · FACT 0.
- **LIMIT-EXPR + rung37 glob** (Opus 4.7, 2026-05-28, `fc166070`): rungs **183** PASS / TOTAL 283 · broker 35 · FACT 0.
- **BANG-EXPR** (Opus 4.7, 2026-05-28, `f92c5bef`): rungs **193** PASS / TOTAL 283 · broker **36** (+1) · FACT 0.
- **GEN-BUILTIN** (Opus 4.7, 2026-05-28, `4e3439c2`): rungs **194** PASS / FAIL 53 / XFAIL 36 / TOTAL 283 · broker 36 · FACT 0.
- **rung36 category split** (Opus 4.7, 2026-05-28, one4all `90701fb9` + corpus `e89681b`): runner-only change, outcomes unchanged. Per-category snapshot at this watermark:
  ```
