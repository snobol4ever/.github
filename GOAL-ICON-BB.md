...
**HEAD (SCRIP) = `d0cbff3`** (uncommitted Icon work staged on top) — m3/m4 **145/283**. icon smoke 12/12 m3+m4 · prolog 5/5 · no-stack 0 · one-reg 0 · semicolon prison green. (`66de67e` is the prior icon-scan commit; `d0cbff3` adds the Prolog arity-4 work from a peer goal.)
