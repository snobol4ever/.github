...
**HEAD (SCRIP) = `fa33cd6`** — m3/m4 **145/283**. icon smoke 12/12 m3+m4 · prolog 5/5 · no-stack 0 · one-reg 0 · semicolon prison green. (`d0cbff3`/`66de67e` are prior; `fa33cd6` is the landed scan-body-generalization commit.)
