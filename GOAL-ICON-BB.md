...
**HEAD (SCRIP) = `654f720` + 1 uncommitted (PENDING PUSH — credential needed)** — m3/m4 **PASS=210 FAIL=42 EXCISED=1** (289 total). icon smoke 12/12 m3+m4 · prolog 5/5 · raku 155/0 · snobol4 m4 7/7 · snobol4 run 176/79 (unchanged) · no-stack 0 · one-reg 0 · semicolon prison green · LVA gate PASS. FAIL sets byte-identical m3=m4.
