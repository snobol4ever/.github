...
**▶ NEXT MOVE: RUNG 1 — climb the crosscheck fail set STATIC-FIRST (read .ref + .s, one stab, verify vs .ref; monitor only on a failed stab). Next sub-rungs: 410 (2**3 exp), 412 (2.0+3.0 real add), 413 (1+2.0 int->real promote). Lon pivot 2026-06-27.**
