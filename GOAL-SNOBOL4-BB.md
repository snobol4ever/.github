...
**NEXT:** **ZW-1/2 UNBLOCKED** (MATCH_BEGIN canonical frame + MATCH_END frame-pop whack; the island arms in those templates are dead) → **ZW-0 stage 2** (dead-arm deletion) → **ZW-3** r12 CAS live → **ZW-5 IR_STATEMENT** per the design above → **ZW-4/6**. Then: m4-EVAL rung · ZD-7c · r9/wire. ⛔ Push of s23k commits awaits credential.
