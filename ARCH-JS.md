...
Backend: JavaScript. Emitter: unified `emit_core.c` (`IS_JS` arms in `SM_templates/` + `BB_templates/`); the former silo `emit_js.c` was deleted in the EC series — see ARCH-ENGINE.md.
