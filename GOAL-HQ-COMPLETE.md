...
⛔ **Pin denial is NOT sufficient for beauty** — with both files at `-O2`+full pin denial the witness passes but beauty still emits 278 bytes in both media. A SECOND mechanism exists; treat the two as possibly distinct.
