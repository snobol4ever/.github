...
**STATE (2026-07-08, Claude): rung suite `PASS=43/115` m2≡m3≡m4 (was 32/32/27). m3≡m4 parity RESTORED. Smoke 5/5/5; icon 12/12x2; no-new-global PASS floor 14. Commits `bf22cc0a` (PL-RES-1 $write + m4 ATOM lazy-init) and `2a342777` (arith value-tree $ax_/$is_v; (,)/2 arm; $faN proc_table registration; NESTED-GENERATOR HANDLE-KEYED RESUME: rt_proc_call_gen_h writes its activation handle to caller slot [off+8], rt_proc_resume_frame resumes by handle — the global-LIFO-top resume was skipping inner clause tails, the [1,,] bug). LOCAL ONLY — push pending credential.**
