...
- [ ] PJ-12c — Verify with ASAN (`ASAN_OPTIONS=detect_use_after_free=1`) that no use-after-free fires from any BB template that cached a raw `BB_t*` address past the free boundary. See PJ-11 for the fix pattern.
