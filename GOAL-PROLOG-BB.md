...
## ▶ STATE (2026-06-27 #4 — bench suite 22 GREEN / 0 frontier / broken=0; rung suite 115/115 m3+m4; m3≡m4)
...
**5. FLAG: pre-existing corpus `.s` drift (20 files stale, unchanged from prior session flag).** Still a separate dedicated-session resync. Not a gate.
