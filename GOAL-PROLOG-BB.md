...
Watermark: SCRIP `84ae655` (battery green). **PL-GZ-0..4, 5a–5c, 6, 6b, 7a, 7b, 8, 8b, 9a, 9b, char_type, sort/msort, numbervars, writeq/write_canonical (A2 partial) LANDED.**
Gates: GATE-1 m2 5/5 HARD · m3 5/5 · m4 5/5. GATE-3 m2 **114**/115 (rung23_arith_ext_power: pre-existing int-power float bug) · m3 **71**/44-FAIL (ratchet floor=71) · m4 **56**/42-FAIL+17-EXCISED (ratchet floor=56).
