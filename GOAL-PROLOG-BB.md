...
Watermark: SCRIP `2127c82` (battery green). **PL-GZ-0..4, 5a–5c, 6, 6b, 7a, 7b, 8, 8b, 9a, 9b LANDED** — details: git history + handoff docs.
Gates: GATE-1 m2 5/5 HARD · m3 4/5 · m4 4/5. GATE-3 m2 **114/115** (rung23_arith_ext_power: `27^3` returns `27.0` not `27` — int-power float promotion bug, pre-existing) · m3 **25**/90-FAIL (ratchet floor = 25) · m4 **50**/55-FAIL (ratchet floor = 50).
