...
**24 m3 failures (floor=91 pass), 18 m4 failures + 10 excised (floor=87 pass; raised from 70 — HEAD already passes 87).** All m3 failures hit PL-GZ FENCE ("not admitted"). Groups:
