...
|--------|------|----------------|
| RT-113 | one4all `5a7e16e` · corpus `3fd44d0` · PASS=178/203 | **M-CMPILE-MERGE Phase 0 ✅** — 553 files swept; trees correct; RT-114: confirm cmpile_lower() is live path → declare M-CMPILE-MERGE done → RUNTIME-6 DT_E blocker |
