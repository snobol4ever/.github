...
```
one4all: ed957bfe (DAI-5b-2: icn_value.c + icn_stmt.c + icn_stmt.h deleted; public AST-walker symbols scrubbed)
corpus:  490f4c7 (unchanged this session)
ir-run:  194/265
sm-run:  194/265  ← from DAI-3, not re-measured this session (DAI-5c)
