...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: SF-8** (corpus gate) then SF-12 (delete emit_bb_stateful, blocked on IF-0..5). SF-11 ✅ ARBNO inline. SF-10 ✅ CALLCAP/CAP_IMM/CAP_COND inline. SF-9 ✅ CHARSET binary inline. SF-7 ✅ `c2da1e32`. beauty 10/17. New: EM-ICN-FLAT (IF-0..IF-6). |
