...
| Snocone Frontend Ladder | `GOAL-LANG-SNOCONE.md` | one4all+corpus | SC-24c DONE: claws5.sno two-phase correct, zero diff vs ref, ~450ms; all 3 .sno PASS, all 3 .sc ready for scrip test; next SC-26; corpus HEAD 8a64bc8 | ☐ |
