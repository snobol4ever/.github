...
| **⚡ PST: Rebus** | `GOAL-PST-REBUS.md` | one4all+corpus+.github | **⏳ Phase 1 NOT clean** — PST-RB-DECL-1..5 open (eliminate `RDecl`/`RCase`/`RProgram` outer wrapper). All audit §⛔ violations RB-C-2..5 ✅ closed 2026-05-19 (Sonnet 4.6). **Next: PST-RB-DECL-1** (add TT_FUNCTION/TT_RECORD_DECL kinds). |
