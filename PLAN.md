...
| Goal | File | Repo | Step |
|------|------|------|------|
| SNOBOL4 Frontend Ladder | `GOAL-LANG-SNOBOL4.md` | one4all | SN-26-bridge-coverage-c (3-way validation on beauty self-host — apples-to-apples now that -a/-b coverage symmetric) |
