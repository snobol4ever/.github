...
| **⚡ Pure Syntax Tree (six frontends)** | `GOAL-PARSER-PURE-SYNTAX-TREE.md` | one4all+.github | **PST-SN4-1a** — strip EXPORT/IMPORT from `sno4_stmt_commit_go`; move to lower/driver. |
