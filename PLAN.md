...
| **PARSER-SNOBOL4 (pattern frontend)** | `GOAL-PARSER-SNOBOL4.md` | corpus+one4all | PARSER-SN-6 LANDED (PASS=58); PARSER-SN-7 REWRITE-0 scaffold landed corpus@d34b23c PASS=3; next REWRITE-1 labels+assign — Stmt assign body |
...
| **Rewrite SCRIP** | `GOAL-REWRITE-SCRIP.md` | one4all | RS-23b (RS-23a-route LANDED session 2026-05-03 cont.) |
