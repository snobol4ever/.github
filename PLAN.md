...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-4 — math builtins** (IJ-1 ✅ `c5bb0775`, IJ-2 ✅ `8529aec9`, IJ-3 ✅ `248379b3`: coro_bb_indirect_callee loop fix — skips non-callable callees, double-call bug fixed; Icon 9.5 oracle confirmed; ir-run 199, honest 266) |
...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-S-ARTIFACTS-COMMIT ESA-2** — regen 7 `.s` artifacts + commit corpus. EM-XVAL-DESCR EXVAL-1..3 ✅ (sess 2026-05-12, `e31ab505`). Baseline: smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty PASS=9. one4all `e31ab505`. |
