...
| **⚡ Universal Generator IR** | `GOAL-LOWER-REDESIGN.md` | one4all+.github | **NEXT: LR-0** — gen_node_t/gen_cfg_t; SM+BB two-land pipeline; all 6 languages; DCG; SM_EXEC_GEN replaces SM_BB_EVAL; Rebus test bed first |
...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: IF-3** (batch C). SF-12-prep pivot: removed --bb-inline-limit switch, deleted 7 C BB impls (ARB/REM/LEN/TAB/RTAB/BAL/BRKX) replaced by inline emitters. IF-0/1/2 ✅ `9a55b3cf`: ICN_EMIT2 macro; 16 ICN boxes converted to two-path inline. |
