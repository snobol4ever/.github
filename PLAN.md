...
| **PARSER-ICON (pattern frontend)** | `GOAL-PARSER-ICON.md` | corpus+one4all | PARSER-IC-10-style Step 5 (Steps 1-4 LANDED PASS=51 corpus@NEW — underscore-id removal, single-stmt-body braces, divider/blank-line sweep, Gray/White rename complete) |
