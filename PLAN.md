...
| **PARSER-SNOCONE (pattern frontend)** | `GOAL-PARSER-SNOCONE.md` | corpus+one4all | PARSER-SC-INFRA-3 Step 3d (Steps 3a+3b+3c DONE; 120-char dividers landed corpus@b52cfa2; next: convert longhand shift/reduce to ~/& OPSYN at 15 call sites) |
