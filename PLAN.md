...
| **⭐ DYNAMIC BYRD BOX** | DYN-3 | .github `c8190c9` · one4all `2ff4647` | **M-DYN-4**: *VAR dynamic dispatch — XDSAR/XVAR deferred to Phase 3 match time. Rung 6 patterns via dynamic path. Read ARCH-byrd-dynamic.md §E_DEFER. |
