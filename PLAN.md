...
| Prolog Frontend Ladder | `GOAL-LANG-PROLOG.md` | one4all+corpus | **PR-19a** (see goal file — strategy pivot: PL-12 monolithic gate replaced by ISO ladder PR-13–PR-24; rung31_bridge_catch 0/5; next: apply v3 bridge diff, gate to 5/5) |
