...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **⛔ REVERT FIRST: icn_bb_every + icn_bb_to in `a82b42c5` are C BBs — wrong. Must be IR_block_t DCGs. Delete C fns, implement IR_ICN_TO + IR_ICN_EVERY DCGs, then IJ-19-to-by.** |
...
| **⚡ Mode-4 Full Suite: SNOBOL4+Snocone** | `GOAL-MODE4-SN4-SNOCONE.md` | one4all+corpus+.github | **NEXT: M4SN-4b** — fix 052_pat_arbno abort (unresolved label="" in brokered XCAT(XNME(XARBN)) blob). Sess 2026-05-14 (`b8d5da36`): 108/280. FAILDESCR test fixed (cmp al,99). Baselines: smoke 7/7 ✅, crosscheck_sn4 6/6 ✅, crosscheck_sc 8/8 ✅, gate_em8 5/5 ✅. |
