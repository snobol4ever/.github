...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-7 remaining** (partial `ae2d16f7`: ~~x NUL+coerce fixed, ~~gen suspension fixed, to-by string/cset coerce fixed; outstanding: to-by alternation args + scan-subject gen + ?x. ir-run 198, honest 268, broker 23) |
