...
| **Snocone sm_lower (M2 path)** | `GOAL-SNOCONE-SM-LOWER.md` | corpus+one4all+.github | **NEXT: SL-13 steps 3-4 — blocked on qize.sc Append bug (hang). SL-13 steps 1+2 ✅ sess 2026-05-12 (Claude Sonnet 4.6): T_2AMP/T_2TILDE fixed (& ~ → reduce/shift in all parser_*.sc), TDump→Lower_collect+Lower_run wired, run_scrip_parser.sh added.** |
