...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: fix stateful-box zeta absolute addr (Class A) + DEFINE_ENTRY frame corruption (Class B)** — broad corpus 155/163; XDSAR+Σ/Σlen fixes ✅ `56a9897a`; beauty 13/17. |
