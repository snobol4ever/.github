...
| **Prolog BB / SM-BAKE** | `GOAL-PROLOG-BB.md` | one4all+corpus+.github | PJ steps ✅ COMPLETE 2026-05-25. **NEXT: SB-1** — bake SM_STNO operand into blob; begin eliminating CUR_INS runtime reads so SM+BB can be freed immediately after SM_codegen (before sm_jit_run). |
