...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | IJ-IRALLOC-OVERFLOW landed (`6ddb9584`): IR_block_t bounds-checked; lower_icn_proc_body 128→4096; IR_ICN_BINOP beta fix. honest 272→276 (+4), broker 17→19 (+2). Watermark: one4all `6ddb9584` · ir-run 126/265 · honest 276 · smoke 5/5 · broker 19/49. NEXT: IR_BINOP_GEN real-typed arithmetic (rung18/rung36 now exit cleanly but produce wrong output). |
