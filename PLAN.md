...
| **TEXTF: literal emit_textf templates** | `GOAL-TEXTF-TEMPLATES.md` | one4all+.github | G1-G6 ✅ all BB_templates. Zero emit_bb_box_banner/bb3c_format remain in templates. one4all `6ee301e9`. PASS=407 FAIL=0 STUB=652. emit_text_jmp stays in bb_pos/bb_lit (fused cjmp output). NEXT: G7 survey JVM arms. Beauty gate SUSPENDED. |
