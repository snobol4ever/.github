...
| **PARSER-REBUS (pattern frontend)** | `GOAL-PARSER-REBUS.md` | corpus+one4all | RB-FW-12 LANDED (2026-05-07, PASS=96 FAIL=0: unary dot; trailing/empty comma arglist. corpus@dac6db3) |
