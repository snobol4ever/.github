...
| **⚡ sm_lower.c refactor (prereq for SL)** | `GOAL-SM-LOWER-REFACTOR.md` | one4all+.github | **NEXT: SR-12** — lower_stmt.c extraction (lower_stmt ≤ 30 lines). Closed: SR-1..SR-10 ✅. **rename ✅ `cc21aa5a`** — sm_lower→lower, cohort_*→lower_*. **SR-9 ✅ `907644e5`** — icn_relop+cset+unary (24 kinds). **SR-10 ✅ `a4545102`** — icn_ctrl+data+sect (19). **SR-11 ✅ `69e7dde8`** — lower_icn_gen (7) + lower_prolog (6); legacy switch now empty. Gate: PASS=30. |
