...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-SNOCONE-PREP (partial)** — RW-6 ✅ `3763151f`; comment cleanup `85b4f292`. Remaining: migrate bb3c_format calls in emit_seq.c to emit_text_3col; IS_TEXT-at-leaf audit. |
