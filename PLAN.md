...
| **Icon BB JCON triage** | `GOAL-HEADQUARTERS.md` | one4all+corpus+.github | **EC-2 🔄 2026-05-19 (Sonnet 4.6, one4all `8b8af8cc`) — emit_bb_node() created in emit_core.c; 5/18 BB kinds migrated (LIT, ANY, NOTANY, SPAN, BREAK). NEXT: ARB, ARBNO, CAT, ALT, LEN, POS/RPOS, TAB/RTAB, REM, FENCE, ABORT, ASSIGN_IMM/COND.** |
