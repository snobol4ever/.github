...
| **⚡ SN4 JVM Emitter (IR_t-based, beauty self-host)** | `GOAL-SN4-JVM-EMIT.md` | one4all+.github | **SJ4-JVM-1 ✅ 2404f429 — all 19 IR_PAT_* BB template emitters in emit_jvm.c; jasmin.jar at src/backend/; gate 19/19; NEXT: SJ4-JVM-2** — SnoRt.j complete JVM runtime class. Concurrent with SN4-JS. |
