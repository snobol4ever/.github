...
| **⚡ PST: Rebus** | `GOAL-PST-REBUS.md` | one4all+corpus+.github | **⏳ Phase 1 NOT clean** — PST-RB-DECL-3..5 open. All RB-C §⛔ violations ✅, DECL-1 ✅ `b4bb0a9c`, DECL-2 ✅ `8af2e2e1` (RDecl/RDKind/RProgram eliminated; parser outputs `tree_t*`). **Next: PST-RB-DECL-3** (RCase scratch doc + free loop + audit re-grade). |
