...
| **one4all-SNOBOL4-NET** | D-197 | snobol4dotnet `da168d6` · **2169p/0f** | D-198: coverage_sno_nodes + word4 (INPUT harness) + strings/cross + output/ audit → ≥2170p |
