...
| Snocone Beauty         | `GOAL-SNOCONE-BEAUTY.md`       | corpus+one4all | SB-4b (session #66 progress: SB-4b.1 global.sc tightened — added missing UTF entry + 7 `&ALPHABET POS LEN` byte-range names; SB-4b.15 NEW semantic.sc — 8 procedures; SB-4b.16 NEW trace.sc — T8Trace/T8Pos. Lon supplied canonical Snocone reference (snocone.sc transpiler) + 368-page SPITBOL manual; key facts recorded in goal-file's "Snocone language facts" section. Per Lon: every construct ports regardless of use, no goto except where genuinely needed. corpus @ fea14df. Remaining: SB-4b.2..SB-4b.14 = 13 modules (case, assign, match, counter, stack, tree, ShiftReduce, TDump, Gen, Qize, ReadWrite, XDump, omega) + SB-5b beauty.sc rewrite of binary &/~ sites + 14 stray gotos. Gate test_beauty_snocone_all_modes.sh PASS=42 FAIL=0 SKIP=3 throughout) |
