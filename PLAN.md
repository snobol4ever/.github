...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-19-remaining** — ir-run 206 (+4 this session). Done: TT_SUSPEND GeneratorState, TT_BANG_BINARY, push/put/pop multi-arg, g_lang fix, !s:=Y every. WIP: !s:=X ICN_ITERATE_FIRST_SET frame-local write. d9fe4677. |
