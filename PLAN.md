...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-9 PARTIAL** (every-as-expr fix ✅ `d1044104`: TT_EVERY removed from is_suspendable, bb_eval_value returns FAILDESCR, lower_expr ctx tracking. Remaining: coro_bb_scan_gen body_gen β-resume for rung36_jcon_scan) |
...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-BB-FORMAT** — EM-DEVTABLE ✅ sess 2026-05-13k (Claude Sonnet 4.6): emitter_t vtable removed; form-based emit_form_* API; emitter.h 557→205 lines; smoke 7/7, byte-id 4/4, em8 5/5. |
