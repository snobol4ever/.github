...
| Snocone Frontend Ladder | `GOAL-LANG-SNOCONE.md` | one4all+corpus | claws5.ref correct (pprint-equiv, 95 lines); treebank refs WRONG format (s-expr not ppr.pprint(bank)); install snobol4python, run assignment3_dump.py, fix pp_node, regen; then SC-26; corpus HEAD 52c4e3b | ☐ |
