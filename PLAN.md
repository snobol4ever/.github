...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: SF-1 (BAL flat template, no RTCALL)** — Class A stateful-box zeta fix ✅ `fa75289f`; Class B attempted+reverted; beauty 10/17; Lon directive: stateful boxes flat not RTCALL (SF-1..8). |
