...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: broad corpus mode-4 run OR accept 13/17 beauty parity and move on** — XDSAR flat_is_eligible fix + symbolic Σ/Σlen text refs ✅ `56a9897a`; beauty 12→13/17; remaining 4 diffs are sm-run accuracy bugs confirmed vs SPITBOL oracle. |
