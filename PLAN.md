...
| Goal | File | Repo | Step |
|------|------|------|------|
| SNOBOL4 Frontend Ladder | `GOAL-LANG-SNOBOL4.md` | one4all | SN-7 (beauty.sno self-host 6 drivers × 3 modes; SN-22 complete — Python-verified push/pop/commit is all that's needed) |
