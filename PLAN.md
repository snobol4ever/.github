...
| **⚡ Mode-4 Full Suite: SNOBOL4+Snocone** | `GOAL-MODE4-SN4-SNOCONE.md` | one4all+corpus+.github | **NEXT: M4SN-4b continued** — broad corpus 189/280 (+3 this sess). Fixed: call_native_chunk locals+retval (icase/recursive pattern funcs). one4all `d811da09`. |
