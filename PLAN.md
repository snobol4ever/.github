...
|---------|--------|------|----------------|
| **SNOBOL4 × x86** | BEAUTY-RUNUP | one4all `8a01e140` · corpus `3fd44d0` · --ir-run PASS=178 · --sm-run PASS=168 | **MILESTONE-SN4X86-BEAUTY-RUNUP.md** · BRU-1: `\|` in FENCE continuations (UNOPTB chrs[124] + nxt_is_token guard) · BRU-2: `&ALPHABET` subject position · BRU-3: beauty self-hosting · BRU-4: crosscheck 6/6 · BRU-5: subsystem 19/19 |
