...
| SNOBOL4 Frontend Ladder | `GOAL-LANG-SNOBOL4.md` | one4all | SN-17 IN PROGRESS: porter.sno under one4all ir/sm = 12,796/23,531 = 54.38% (SPITBOL = 100%); root cause is SN-6 Bug #1d. SN-16 DONE. SN-7 next: Bug #1d remainder — this session added two observations: (1) stderr 'snobol4:0: error: parse error' fires at LOAD time before runtime — isolate which line in expr_eval.sno; (2) scrip fires 2 extra Push() for 1+2+3 vs SPITBOL (match-time commit-time for . already in place, leak is elsewhere); speculative bb_deferred_var NAM_mark fix was reverted. SN-6 PASS=218/228. HEAD 25ab6fe7 | ☐ |
