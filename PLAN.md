...
| **Icon BB JCON triage** | `GOAL-HEADQUARTERS.md` | one4all+corpus+.github | **NEXT: ISO-4** — scrip_parse subprocess (TDump/TLump pipe).  ISO-1/2/3 ✅ at `cb1738f6` (parse->lower carries only tree_t*; both firewall gates green).  Also IR-CD-5/6/7 still open and IR-RN-3/4/5 owed.  Watermark `cb1738f6`. |
