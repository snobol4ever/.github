...
| **PARSER-SNOBOL4 (pattern frontend)** | `GOAL-PARSER-SNOBOL4.md` | corpus+one4all | PASS=78/78 ✅ corpus@ebb9b72 — Next: **SN-7-7b** emit E_* directly from grammar; delete rw_tag. |
