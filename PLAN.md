...
| **⚡ IR_t Emitter Foundation (prereq for JVM+JS)** | `GOAL-IR-EMITTER-PREREQ.md` | one4all+.github | **GOAL COMPLETE** — IEP-1..3 ✅; vtable redesign ✅ `92f628b0`. One `emit_ir_block` entry for all 6 backends × all 6 frontends; vtable dispatch inside single `ir_walk`; `emit_ir_targets.c` holds 6 stub vtables; JVM+JS plug in via GOAL-SN4-JVM-EMIT / GOAL-SN4-JS-EMIT. |
