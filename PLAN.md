...
| **⚡ PST: Raku** | `GOAL-PST-RAKU.md` | one4all+corpus+.github | **⏳ Phase 1 NOT clean** — 22 §⛔ violations remaining. PRF-12-say ✅ PRF-12-print ✅ PRF-12-sub ✅ PRF-12-body-splice ✅ (subsumed) PRF-12-die ✅. one4all `c596462d`, corpus `adfdbb6`. NEXT: PRF-12-class (R16-17, TT_CLASS_DECL) or PRF-12-arr-hash-ops (R7-9). ⚠ Always regen `raku.tab.c` with `bison -d raku.y -o raku.tab.c` after any `raku.y` change. |
