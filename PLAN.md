...
| **PARSER-SNOBOL4 (pattern frontend)** | `GOAL-PARSER-SNOBOL4.md` | corpus+one4all | PARSER-SN-6 LANDED (PASS=58); PARSER-SN-7-0 LANDED corpus@afbc6be PASS=3; next SN-7-1 labels+assign |
