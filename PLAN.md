...
| **⭐ DYNAMIC BYRD BOX** | DYN-74 | one4all `52e21fd` · corpus `8d5cc6a` | **177p/1f** · **DYN-75**: fix expr_eval (C stack overflow — recursive pattern) → MONITOR vs SPITBOL → **178p/0f → M-DYN-INTERP-FULL** |
