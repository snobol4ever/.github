...
| **PARSER-SNOCONE (pattern frontend)** | `GOAL-PARSER-SNOCONE.md` | corpus+one4all | PARSER-SC-6b ⏳ BROKEN — whitespace cleanup regressed gate to PASS=35 FAIL=11; next: fix NonKwId keyword exclusion |
