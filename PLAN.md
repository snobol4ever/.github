...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-7d** — beauty PASS=14/17. Remaining: semantic_driver tests 4–7 (root cause: bb_pool exhaustion from global.sno ALPHABET patterns; fix = bb_pool_reset() after exec_stmt); stack/counter pre-existing mode-2 bugs. one4all `c0675506`. |
