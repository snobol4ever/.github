...
| **Icon BB JCON triage** | `GOAL-HEADQUARTERS.md` | one4all+corpus+.github | **EC-BB-UNIFY-2 ✅ COMPLETE 2026-05-19 (Opus 4.7, one4all `50217d15`) — compile-time PATND_t→IR_t in emit_walk_phase2 + eligibility helpers; fixes 1fc21e2d type-pun UB; obsolete EM-7a/EM-7b tests retired; -140 LOC. Gates floor. NEXT options: EC-3 (SM instruction template migration), IR-RN-0 (bulk IR rename), or EC-BB-UNIFY-3 (runtime stmt_exec.c PATND_t→IR_t).** |
