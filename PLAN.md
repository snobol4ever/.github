...
| **SCRIP Head Quarters** | `GOAL-HEADQUARTERS.md` | one4all+corpus+(.github) | **EC-UNI-INLINE-0 NEXT** (delete dead emit_sm_*/emit_bb_x* — 71 dead SM fns + 14 dead BB fns confirmed via empirical caller audit). Then INLINE-1..7 (inline body of `_dispatch` shims into template arms). PPV-9 ✅. one4all `794b9435`. GATE-PK PASS=420 FAIL=0 STUB=639. EC-UNI-22 (close/docs) sequenced AFTER INLINE-ALL. |
