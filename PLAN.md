...
| Snocone Frontend Ladder | `GOAL-LANG-SNOCONE.md` | one4all+corpus | FINDING: 32 mid-line N_CRD markers are tagging errors; true sentinel=POS(0) SPAN(DIGITS) '_CRD :_PUN '; new Phase 1 = tight loop no slurp; claws5.ref needs regen | ☐ |
