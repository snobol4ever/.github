...
|---------|--------|------|----------------|
| **SNOBOL4 × x86** | TILDE | one4all `c30de4ca` · corpus `3fd44d0` · --ir-run PASS=178 · --sm-run PASS=168 | 1. MILESTONE-SN4X86-TILDE.md · 2. MILESTONE-SN4X86-ALPHABET.md · 3. MILESTONE-SN4X86-SELFHOST.md · 4. MILESTONE-SN4X86-BEAUTY.md |
