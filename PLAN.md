...
| Raku Frontend Ladder | `GOAL-LANG-RAKU.md` | one4all | RK-32 next: BB-native NFA RE engine; RK-32..69 planned: NFA/captures/code-asserts, file I/O, BB grammar, GDE, combinators, multi dispatch, Match object | ☐ |
