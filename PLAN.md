...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-19-iterate** — TT_ITERATE (!str,!list,!table) as IR_ICN_ITERATE DCG. IJ-19-to-by ✅ `a0b0700b`: IR_ICN_TO_BY, ir-run 149→150. |
