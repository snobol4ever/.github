...
| **PARSER-SNOCONE (pattern frontend)** | `GOAL-PARSER-SNOCONE.md` | corpus+one4all | PARSER-SC-INFRA-3 Step 3d-bug (Steps 3a+3b+3c+3d DONE; corpus@a82b43c; Step 3e BLOCKED on newly-filed scrip pattern-engine bug — `$'  ' = *White` alias does not behave identically to `*White` in recursive grammar rules; engine-level fix in snobol4_pattern.c needed) |
