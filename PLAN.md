...
| **BB Template Ladder — Icon + Prolog** | `GOAL-BB-TEMPLATE-LADDER.md` | one4all+corpus+.github | ICN-T-2 ✅. Phase F active `5871962e` — SM_BB_SWITCH, F-6a/b/c done. **NEXT: rename BB_t.ival→ival1, then F-6d** (BB_BINOP_GEN/ARITH/UNIFY pure ports). |
