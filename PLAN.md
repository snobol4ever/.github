...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EDP-4 — sm_codegen_x64_emit.c reduced to dispatch** (EDP-3 ✅ `ed41f343`; --bb-macros flag wired `ec334068`; EM-BB-MACROS spec corrected — after EDP-12, raw x86, jumps col 3, no named macros). Baseline: smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty-subsystems PASS=7. |
