...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-19-remaining** — debug bb_exec_stmt body drop in IR_ICN_EVERY (rung13_alt_alt_filter); then TT_SEQ_EXPR, TT_SUSPEND. ir-run 149→174 this sess, honest 271→276, broker 21→23. |
