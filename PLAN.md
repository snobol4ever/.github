...
=======
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: fix pattern-match-in-userfn segfault (match_driver) + investigate remaining 7 diff failures. Sub-rung -u ✅ `7e123dc6` (Claude Sonnet 4.6, sess 2026-05-12): beauty-subsystems PASS=5 (baseline=4). Six bugs fixed this sess (broken block comments, ast.h include, EXP_R_fn→pow, SM_PAT_* fall-through, bb_emit double-emission, SM_DEFINE_ENTRY dispatch).** |
