...
| **PARSER-SNOBOL4 (pattern frontend)** | `GOAL-PARSER-SNOBOL4.md` | corpus+one4all | EMERGENCY 2026-05-03: v2 deleted, full rewrite corpus@5ca656e PASS=0 FAIL=59. Next: debug empty Compiland output |
