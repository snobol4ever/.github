...
| **PARSER-SNOBOL4 (pattern frontend)** | `GOAL-PARSER-SNOBOL4.md` | corpus+one4all | PARSER-FAMILY-LOOP iter#3 LANDED session 2026-05-04 cont. #7 — Correct bracket/keyword whitespace per SNOBOL4 model; open brackets ws-after-only, close brackets ws-before-only, keywords left-ws only. Gates: SN=59 IC=51 PR=54 RK=32 SC=21 RB=38 (all 100%). Next: operator picks iter#4 concept. |
