...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **EM-FORMAT-CHUNK-RENAME (chunk→expression) landed sess 2026-05-10.** Next: EM-7d-beauty-subsystems (blocked on SN-33 cap_t::fn fix). |
