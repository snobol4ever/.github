...
| **⭐ DYNAMIC BYRD BOX** | DYN-23 | one4all `27300c5` · .github (this) · corpus `31ad542` | **M-DYN-OPT**: wire Pass 2b + preamble in emit_program(). Then **M-INTERP-A01**: scrip-interp driver + bb_test harness. See SESSION-dynamic-byrd-box.md + MILESTONE-DYN-INTERP.md. |
