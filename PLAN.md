...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: IF-4** (batch D). SF-12-prep pivot: removed --bb-inline-limit switch, deleted 7 C BB impls (ARB/REM/LEN/TAB/RTAB/BAL/BRKX) replaced by inline emitters. IF-0/1/2/3 ✅ `158e0a88`. |
