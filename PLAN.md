...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-19-alternate** — TT_ALTERNATE (A|B) as IR_ICN_ALTERNATE DCG. IJ-19-iterate ✅ `8cf94938`: ir-run 150→153, broker 21→22. |
