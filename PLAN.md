...
| **Icon BB JCON triage** | `GOAL-HEADQUARTERS.md` | one4all+corpus+.github | **DAI-8 SWEEP DONE ✅ 2026-05-18 (Sonnet 4.6, one4all `f82a34c9`) — C8–C16 complete. All auditable dead fns deleted. Remaining GC-dead sections anchored live. NEXT: DAI-8 C17 or new goal per Lon.** |
...
| **⚡ PST: Raku** | `GOAL-PST-RAKU.md` | one4all+corpus+.github | **⏳ Phase 1 NOT clean** — 21 §⛔ violations remaining. PRF-12-say ✅ PRF-12-print ✅ PRF-12-sub ✅ PRF-12-body-splice ✅ (subsumed) PRF-12-die ✅ PRF-12-arr-hash-ops ✅. one4all `ac0e48f3`, corpus `9f4e7af`. NEXT: PRF-12-class (R16-17, TT_CLASS_DECL) or PRF-12-program (R1). ⚠ Always regen `raku.tab.c` with `bison -d raku.y -o raku.tab.c` after any `raku.y` change. |
