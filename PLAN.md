...
| **Prolog Frontend Ladder** | `GOAL-LANG-PROLOG.md` | one4all+corpus | **PR-15** (PR-14 rung37_term_ops LANDED — =.., functor/3, arg/3, copy_term/2 all passing. Next: rung38_iso_errors ISO §7.10) |
