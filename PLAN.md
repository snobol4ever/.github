...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-8** — beauty PASS=14/17. EM-7d ✅ sess 2026-05-13 (Claude Sonnet 4.6, one4all `741d7583`): rt_match_variant setjmp + exec_stmt_pool_reset on error path. counter/semantic/stack pre-existing mode-2 divergences. |
