...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: SF-12** (delete emit_bb_rtcall_data). SF-8 ✅: beauty 17/17, IDENT/DIFFER fix, ARBNO/CAP startup patching. |
