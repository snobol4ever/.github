...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: RW-1** — EM-REWRITE 5-step plan (sess 2026-05-13z). Three diseases diagnosed. ~500 lines replaces ~2,400. RW-1: write `em_mode`, `em_label`, `em_text`, `insn` alongside old code. |
