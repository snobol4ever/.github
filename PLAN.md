...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: RW-0** — naming scan → `ARCH-EMITTER.md`. EM-REWRITE 7-step plan (RW-0..RW-6) complete. Three diseases diagnosed. Two-axis mode, X-group macros, table-driven BB boxes, shape-class SM ops. >2× reduction target. |
