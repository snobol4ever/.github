...
| **⚡ PST: Raku** | `GOAL-PST-RAKU.md` | one4all+corpus+.github | **⏳ Phase 1 NOT clean** — 23 §⛔ violations remaining. PRF-12-say ✅ PRF-12-print ✅ PRF-12-sub ✅ PRF-12-body-splice ✅ (subsumed). one4all `96a7ca59`, corpus `39af2e1`. NEXT: PRF-12-die (R23, ~3 sites, TT_DIE) or PRF-12-class (R16-17). ⚠ Always regen `raku.tab.c` with `bison -d raku.y -o raku.tab.c` after any `raku.y` change. |
