...
| **RUNTIME (scrip-interp)** | RT-120 | one4all `e41b2aa` · corpus `3fd44d0` · PASS=178/203 | M-DYN-B10 COMPLETE ✅ 100% binary coverage — next: P2E embedded match `(A ? PAT = REPL)` or RUNTIME gap per §NOW |
