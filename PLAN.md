...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-REORG-1** — 11-step pure-move reorg plan added (16→14 files, by call-hierarchy level). one4all `1fc4490c`. Gates: smoke 7/7, byte-id 4/4, em8 5/5. |
