...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: BB templates (EM-TEMPLATE-PURITY) — fix all six BB templates to pure t_* calls.**  -s ✅ sess 2026-05-11 (Claude Sonnet 4.6, one4all `f33589d8`): all 53 SM opcodes covered — sm_var.c, sm_push_lit_s.c, sm_exec_stmt.c. SM templates 100% complete. |
