...
| **Snocone sm_lower (M2 path)** | `GOAL-SNOCONE-SM-LOWER.md` | corpus+one4all+.github | **NEXT: SL-13 — parser→lower pipeline integration (await Lon decision).** SL-12 ✅ sess 2026-05-12 (Claude Sonnet 4.6): EVAL(*expr) special case. Phase 1+2 lowering complete. corpus `e408c87`. |
