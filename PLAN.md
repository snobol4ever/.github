...
| **⚡ PST: SNOBOL4 + Snocone** | `GOAL-PARSER-PURE-SYNTAX-TREE.md` | one4all+corpus+.github | **Active HQ rung: PST-LR-AUDIT-1** — per-production audit of all six C parsers; scans 1–3 ✅ (11 Snocone, 1 Icon, 2 SNOBOL4 violations under correctly-scoped rules); scans 4–6 (Raku, Rebus, Prolog) pending. **Also active: PST-SC-4k** (Snocone goto→TT_GOTO_U). Phase 1 marked ⏳ for Icon and SNOBOL4 (was ✅; audit revision). |
