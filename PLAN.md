...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-BB-MACROS** — `--bb-macros` raw x86 three-column BB output. EC-1..EC-8 all closed (one4all `08707cb0`): unified single emitter, C BB boxes eradicated, bb_templates.c Snocone-ready, ARCH-EMITTER.md written. Baseline: smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty-subsystems PASS=10. |
