...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-7 remaining** (partial `ce8c1211`: operator string invocation done; to-loop truncation + ~~ + ? outstanding. ir-run 198, honest 268, broker 23) |
