...
| Goal | File | Repo | Step |
|------|------|------|------|
| SNOBOL4 Frontend Ladder | `GOAL-LANG-SNOBOL4.md` | one4all | SN-23e (delete NAME_save/discard/top/pop_above — API surface collapse after SN-23d closed SN-6c --ir-run) |
