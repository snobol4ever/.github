...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-BB-2** (fill 7 bb_eval_value gaps; IJ-BB-1 ✅ gap table: TT_INTERROGATE/GLOBAL/INDIRECT/NAME/RECORD/VLIST/OPSYN) |
...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: S200-5 (emit_sm.c)** — S200-4 ✅ `72840167` emit_bb.c 1532→1368. SF-1 ✅ `3fcc90a7` emit_bb_xbal inline loop. Note: BAL frontend keyword wiring missing (PUSH_VAR not XBAL). beauty 10/17. |
