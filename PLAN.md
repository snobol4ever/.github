...
| **⭐ DYNAMIC BYRD BOX** | DYN-52 | one4all `ce40aab` · corpus `2f2bbe3` | **DYN-53**: fix build (split compile/link) · confirm _XNME enum match (stmt_exec vs snobol4_pattern) · fix word1–word4/cross · target ≥125p |
...
| **SNOBOL4 JS** | SJ-13 | one4all `9f14686` · .github this | **SJ-14**: fix SEQ multi-element backtracking in sno_engine.js → word1-4/wordcount/cross · check 1015_opsyn. Target ≥170p. |
...
| **⭐ one4all-SNOBOL4-NET** | D-172 | one4all `0ddeb97` | **149p/29f** · MSIL/net8 ABI issue open · D-173: resolve boxes.dll, fix 1012/word*/411 → ≥ 160p |
