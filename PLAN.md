...
| **SNOBOL4 Pattern BB** | `GOAL-SNOBOL4-BB.md` | one4all+corpus+.github | SBL-G-1 (gate script) → SBL-TAB-2 (TAB BINARY reloc) → SBL-CAP-2 (capture BINARY) → SBL-CALLOUT-2/3 → SBL-VERIFY. |
...
| **Prolog BB / SB-LINEAR** | `GOAL-PROLOG-BB.md` | one4all+corpus+.github | ⛔ **TOP: Prolog RUNG LADDER.** GATE-3 **85/107** `b5614aa5` (2026-05-27). NEXT: rung15 abolish, rung18 plus/3, rung25 term_to_atom ops, rung28 catch/throw, then EMITTER AGW-9 (`flat_drive_pl_seq`). |
