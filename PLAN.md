...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: sub-rung -r (SM_PAT_* opcodes).**  -q ✅ sess 2026-05-11 (Claude Sonnet 4.6, one4all `6aeb2d67`): SM_RETURN/RETURN_VARIANT templates + t_mov_edi_imm32/t_test_eax_eax/t_jz_retskip/t_retskip_label.  -p ✅ sess 2026-05-11: SM_CALL_FN.  Gates: smoke 7/7; template-byte-id 4/4. |
...
| **Snocone sm_lower (M2 path)** | `GOAL-SNOCONE-SM-LOWER.md` | corpus+one4all+.github | **SL-2 next: emit_goto. SL-1 ✅ `3de3f44`. Sess 2026-05-11: lower.c audited+fixed (`4ca192a3`), SPITBOL manual read, handoff note in goal file.** |
