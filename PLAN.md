...
| **⚡ Mode-4 Full Suite: SNOBOL4+Snocone** | `GOAL-MODE4-SN4-SNOCONE.md` | one4all+corpus+.github | **NEXT: M4SN-4b continued** — broad corpus 124/280 (+6). Fixed: ARBNO . V variant capture (three bugs: pre_build_children XNME/XFNME child must be brokered; rt_bb_cap β cap_start span; emit_seq_port_call binary push r12→r10). Sess 2026-05-14c (`b6b6e09d`). |
