...
| Snocone Frontend Ladder | `GOAL-LANG-SNOCONE.md` | one4all+corpus | SC-31 DONE: pp_mem replaces pp_table, zero diff vs Python pprint(mem); next: SC-26 (. *fn() capture bug) | ☐ |
