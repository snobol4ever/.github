...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: TT_LOOP_BREAK/NEXT + TT_CASE + TT_SIZE coverage** (sess 2026-05-16: IJ-AUGOP-REPEAT-ALT-NOT landed `17eae4a3`: TT_AUGOP/TT_REPEAT/TT_ALTERNATE/TT_NOT + IR_CALL user-proc dispatch. ir-run 31→56 +25). |
