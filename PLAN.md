...
|------|------|------|--------------|-------|
| In-Process Sync Monitor | `GOAL-INPROC-MONITOR.md` | one4all | IM-15 next (refactor spitbol_run_steps to fork+exec — longjmp/asm stack incompatible); IM-13/14 done, IM-15 infra done | ☐ |
