...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EC-3 — Introduce `emit_bb_stateful()` helper** (EC-1 ✅ `3ec4fcec`: zero C BB calls — all templates use rt_bb_* or inline x86; EC-2 ✅ `44c2d621`: grouped extern decls). Baseline: smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty-subsystems PASS=10. |
