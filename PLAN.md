...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-16** (IJ-15 ✅ `52db8b96`: cset literal/builtin/ops + coro_stmt default fallback; ir-run 201, honest 275. IJ-14 ✅ `00cec4c3`: fix coro_bb_iterate static-alias bug every put(L,!s); IJ-13c ✅ DT_FH. ir-run 200, honest 274.) |
