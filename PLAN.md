...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-BB-MACROS** — raw x86 three-column GAS for BB boxes (EDP-10/11/12 ✅ `a21a6e19`, EM-DOPPELGANGER-PURGE closed). Baseline: smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty-subsystems PASS=11. |
