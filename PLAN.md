...
| D5 | SNOBOL4cython v2 repo destination | New org repo · Fold into SNOBOL4-python · **Fold into SNOBOL4-tiny** · Leave in zips | **Folded into SNOBOL4-tiny `reference/snobol4cython/`** — v1 `f9a1b99` (Arena allocator), v2 `3fb37a5` (per-node malloc). Two commits preserve evolution. Keep it: proof-of-concept engine.c was extracted from; future SPIPAT replacement candidate. | Revisit when engine stable — consider as SPIPAT replacement under SNOBOL4-python |
