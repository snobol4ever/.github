...
| **⚡ Universal Generator IR** | `GOAL-LOWER-REDESIGN.md` | one4all+.github | **NEXT: LR-S1b (cont.)** — broad corpus 155/280; remaining: TT_VAR deref in patterns (ARBNO via var, FENCE via var, star_deref), dynamic-arg patterns. Fixed sess 2026-05-14c: IR_PAT_POS/TAB union clobber (+10, 145→155). renames ✅ `92213ee1`; reorg ✅ `553a836a`; LR-S1b partial `aecf97bb` |
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-19 — Cluster O triage** (IJ-18 ✅ 1203986f: any/many/upto non-advancing, real scan-subj coercion; profsum/ck XFAIL; ir-run FAIL 39, honest 276) |
...
| **⚡ Mode-4 Full Suite: SNOBOL4+Snocone** | `GOAL-MODE4-SN4-SNOCONE.md` | one4all+corpus+.github | **NEXT: M4SN-3b** — crosscheck_snocone 8/8 (beauty_fence + beauty_global UTC pre-existing). Sess 2026-05-14: M4SN-0a/0b/0c/1/3a ✅ (user-func dispatch + movsxd GAS encoding bug; all mode-4 pattern matches now work, one4all `296e85b6`). Baselines: beauty 17/17, crosscheck_sn4 6/6 ✅, crosscheck_sc 6/8, gate_em8 5/5 ✅, EM-7c ✅. |
