...
| **PARSER-SNOBOL4 (pattern frontend)** | `GOAL-PARSER-SNOBOL4.md` | corpus+one4all | PASS=78/78 ✅ corpus@0390853 — SN-7-7b landed: E_* direct + rw_tag deleted. Next: SN-7-8 beauty.sno crosscheck. |
...
| **PARSER-RAKU (pattern frontend)** | `GOAL-PARSER-RAKU.md` | corpus+one4all | PARSER-RK-11 LANDED PASS=60 FAIL=0 corpus@f663327 — unless/until + push/pop. Next: RK-12 — string ops or logical && \|\| ! |
| Snocone claws5.sc | `GOAL-SNOCONE-CLAWS5.md` | one4all+corpus | CL-2 |
| Snocone treebank-list.sc | `GOAL-SNOCONE-TREEBANK-LIST.md` | one4all+corpus | TB-1 |
| **Snocone-in-Snocone** | `GOAL-SNOCONE-IN-SNOCONE.md` | one4all+corpus | SS-0 |
| **Rewrite SCRIP** | `GOAL-REWRITE-SCRIP.md` | one4all | RS-23e (RS-23c/d LANDED 2026-05-04 @ `0de9a2cf`; RS-23-extra-prep SCAN-builtin lift LANDED 2026-05-04 @ `5053e80b`; RS-23-extra-prep2 Option B′ smart fallback LANDED 2026-05-05 @ `dfa7eda4`; RS-23-extra LANDED 2026-05-05 @ `b0b5863a` — diag at zero, two physical fallthroughs ready to harden) |
