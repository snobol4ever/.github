...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-10** (IJ-9 ✅ `4008701c`: coro_bb_scan_gen beta fix — set body_live=0, advance subject. rung37_scan_alt. honest 268→269.) |
