...
| **PARSER-SNOCONE (pattern frontend)** | `GOAL-PARSER-SNOCONE.md` | corpus+one4all | PARSER-SC-6b ⏳ PASS=46 FAIL=0. Expr ladder restructured to beauty.sno (Expr2/7/8/10/13/14 added; Expr14 stripped of =|&? unary; $[ fix; ExprList added). beauty.sc crosscheck blocked: `+` continuation markers parsed as unary + with newline=whitespace. Lon decides crosscheck target next session. |
