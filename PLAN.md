...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-BB-1** (audit bb_eval_value coverage vs lower.c scalar cases; CORO-3 ✅ `33625214`, CORO-4 ✅ `b7f5de14`) |
