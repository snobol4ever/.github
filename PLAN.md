...
| **⚡ Mode-4 Full Suite: SNOBOL4+Snocone** | `GOAL-MODE4-SN4-SNOCONE.md` | one4all+corpus+.github | **NEXT: M4SN-3b** — beauty_fence fix (beauty_global ✅ `453fcbd7`). Sess 2026-05-14b: SIZE(array) fixed 4 paths; beauty_fence blocked (emit_bb xlnth binary paths cause mode-4 parity regression — approach B next: exclude XNME from flat). Baselines: beauty 17/17, crosscheck_sn4 6/6 ✅, crosscheck_sc 7/8, gate_em8 5/5 ✅, EM-7c ✅. |
