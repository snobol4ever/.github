...
| Snocone Frontend Ladder | `GOAL-LANG-SNOCONE.md` | one4all+corpus | SC-31 next: assignment3_dump.py committed; spipat exception blocks claws_info on full corpus — needs chunked input; corpus HEAD 670a426 | ☐ |
