...
| **⚡ PST: Raku** | `GOAL-PST-RAKU.md` | one4all+corpus+.github | **⏳ Phase 1 NOT clean** — 20 §⛔ violations remaining. PRF-12-say/print/sub/die/arr-hash-ops/class ✅. one4all `17a4dc45`, corpus `21a4fc1`. NEXT: PRF-12-program (R1) or PRF-12-for (R12-13). ⚠ Always regen `raku.tab.c` with `bison -d raku.y -o raku.tab.c` after any `raku.y` change. |
