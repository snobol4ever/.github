...
| Snocone Frontend Ladder | `GOAL-LANG-SNOCONE.md` | one4all+corpus | SC-24c DONE: TRIM fix confirmed correct; claws5.sno zero diff vs ref; next SC-26; corpus HEAD 8a64bc8 | ☐ |
