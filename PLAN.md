...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-TEMPLATE-COMPLETE — TC-SPLIT-1 through TC-SPLIT-11 (split multi-opcode SM files), then TC-SM-1..37 (35 missing SM templates), then TC-BB-1..14 (14 missing BB templates). Audit sess 2026-05-12: 54/89 SM covered, 14/28 BB covered. Dead opcodes deleted (SM_TRIM/SPCINT/SPREAL/SELBRA/RCOMP/STATE_PUSH/STATE_POP/JUMP_INDIR). one4all `554aa38f`.** |
