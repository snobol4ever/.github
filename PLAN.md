...
| **Prolog BB Complete (honest mode 3)** | `GOAL-PROLOG-BB-COMPLETE.md` | one4all+.github | **NEXT: PB-5 TT_CHOICE unnamed/dynamic.** PB-0..PB-4 ✅ `1af5368e` (Claude Sonnet 4.6): honest dial 17→**105**/294. Key: initialization directive fix + assertz/asserta → PL_BUILTIN. |
