...
| **Icon BB JCON triage** | `GOAL-HEADQUARTERS.md` | one4all+corpus+.github | **EC-UNI-0..2d ✅; EC-UNI-3 partial 🔄; EC-UNI-8 ladder added; EC-UNI-8.1 ✅; EC-UNI-8.2 ✅; EC-UNI-8.3 ✅ (matrix gate 0/730); EC-UNI-8.4 partial 🔄 (audit logged, 4 silo walkers + 1 legacy walker + 5 whitelisted).** Gates floor flag-off and flag-on. **NEXT: EC-UNI-3-beauty** (prerequisite for EC-UNI-4) or **EC-UNI-8.4-fix** (collapse 4 walker switches into emit_sm_dispatch).
