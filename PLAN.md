...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: S200-6 (sm_jit_interp.c)** — S200-5 ✅ `68ab8cd7` emit_sm.c seps 120→200. S200-4 ✅ `72840167` emit_bb.c 1532→1368. SF-1 ✅ `3fcc90a7`. beauty 10/17. |
