...
| Snocone Frontend Ladder | `GOAL-LANG-SNOCONE.md` | one4all+corpus | SC-24c IN PROGRESS: two-phase now canonical claws5.sno+.sc; Phase 2 BLOCKER: try s=sent[i] copy before match; corpus HEAD 0844598 | ☐ |
