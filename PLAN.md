...
| Snocone Frontend Ladder | `GOAL-LANG-SNOCONE.md` | one4all+corpus | SC-24c IN PROGRESS: two-phase draft committed; Phase 1 OK (244 sent, BREAKX(SEP)); Phase 2 BLOCKER: ARRAY element subject hangs claws_pat_2 -- try s=sent[i] copy; corpus HEAD 5a832d4 | ☐ |
