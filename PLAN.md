...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-9 PARTIAL** (every-as-expr fix ✅ `d1044104`. Root cause sess 2026-05-13: coro_bb_scan_gen on β must NOT resume body_gen β — advance subject instead. One body α per subject.) |
...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-BB-FORMAT** — ESP-11..14 ✅ sess 2026-05-13m (Claude Sonnet 4.6): sm_codegen binary dispatch unified to emit_standard_blob; 1400 lines emit_me*_blob deleted; sm_codegen_x64_emit.c/.h merged into sm_codegen.c and deleted; sm_codegen_text() is new TEXT entry point. one4all `9470c409`. Gates: smoke 7/7, byte-id 4/4, em8 5/5. |
