...
| **Icon BB JCON triage** | `GOAL-HEADQUARTERS.md` | one4all+corpus+.github | **EC-UNI-0 ✅ (f29c95e9), EC-UNI-1 ✅ (e2491770) 2026-05-19 (Opus 4.7). NEXT: EC-UNI-2** — `IS_X86_TEXT` arms in sm_arith (9 fns), sm_compare (3), sm_control (4), sm_pat (30), sm_return family. Same pattern: un-static dispatcher, declare in emit_sm.h, call from `IS_X86_TEXT` arm.
