...
| **⚡ Icon BB Native (flat BB templates)** | `GOAL-ICON-BB-NATIVE.md` | one4all+.github | **NEXT: IB-2 — emit_bb_icon_iterate (!E). IB-0 ✅ `c8032b0c`; IB-1 ✅ `3b1ee228`: lower_to→SM_BB_PUMP_AST N1=216. Boxes are x86 blobs via t_* template functions, one emit_bb_icon_* per construct. 10 rungs IB-0..IB-10, 7 gates each. |
