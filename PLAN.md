...
| Goal | File | Step |
|------|------|------|
| **ICON-BB** | `GOAL-ICON-BB.md` | **LFJ-0** (LOWER FROM JCON staircase, supersedes AG-PURE per `LOWER-REWRITE-FROM-JCON.md`, 4th request from Lon). Next: write `LOWER-IRGEN-MAPPING.md` — JCON chunk/label model → SCRIP BB port model. AG-PURE 1–8.2 frozen as legacy baseline (`7acc7849`). Gates: smoke 5/5, broker 24, rungs 198, smoke_prolog 5/5. |
