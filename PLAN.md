...
| Icon Frontend Ladder | `GOAL-LANG-ICON.md` | one4all | IC-9 (session #30, 2026-05-02: three fixes — & parser precedence (tighter than := was wrong, fixed to looser), icon-frame E_SEQ case added, find/upto icn_bb_find_gen_subj/icn_bb_upto_gen_subj for generative subjects. rung36 14/31/30, ladder 202/31/30. one4all HEAD 1e515891.) |
...
| **Rewrite SCRIP** | `GOAL-REWRITE-SCRIP.md` | one4all | RS-0 |
