...
| SNOBOL4 Frontend Ladder | `GOAL-LANG-SNOBOL4.md` | one4all | SN-6 IN PROGRESS: PASS=218/228; Bug #1c FIXED (f9995d0b — NAM_commit callcap wrote DT_N not matched text); Bug #1d PARTIAL (f4c8b833 — NAM_mark/NAM_rollback_to + bb_alt arm-failure rollback; expr_eval 4/5 now correct); next: extend same rollback into bb_seq right_ω for the 1+2*3 case; smoke PASS=7, broker PASS=49 | ☐ |
