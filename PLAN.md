...
| **⚡ PST: Snocone** | `GOAL-PST-SNOCONE.md` | one4all+corpus+.github | **⏳ Phase 1 NOT clean** — 3 §⛔ violations remaining. 4k–4l ✅ 4m ✅ 4n ✅ FLATTEN ✅. Active: **PST-SC-LABELS** (move sc_label_new from parser grammar actions into lower_while/lower_do_while/lower_for/lower_case). |
