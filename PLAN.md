...
| **PARSER-SNOCONE (pattern frontend)** | `GOAL-PARSER-SNOCONE.md` | corpus+one4all | PARSER-SC-INFRA-3 Step 3c (Steps 3a + 3b banked session #65; SC-3 landed PASS=21; cross-PARSER style canonical at `GOAL-PARSER-SNOBOL4.md ## Style Guidelines for parser_*.sc`) |
| **PARSER-REBUS (pattern frontend)** | `GOAL-PARSER-REBUS.md` | corpus+one4all | PARSER-RB-0a (style cleanups landed corpus@da12182: G1/G2/G6/G8/G11 applied to fresh 134-line atoms-only rewrite; G3/G10 deferred. Hang RESOLVED. Gate now PASS=0 FAIL=38 with tree-equality FAILs — END-leak blocker: ARBNO body consumes 'end' as bare Id via shift, doesn't unwind on backtrack. Next: match()/NotInList predicate idiom from beauty.sno § 24-28.) |
