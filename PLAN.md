...
| **⚡ PST: Rebus** | `GOAL-PST-REBUS.md` | one4all+corpus+.github | **RB-C-1b ✅** 2026-05-18 (Sonnet 4.6, one4all `ed3f8efc`): flat accumulation in stmt_list_ne — compound_stmt children spliced, single stmts appended, no wrapping, no post-pass. NEXT: PST-RB-PRE-BEAUTY Bug #2. |
