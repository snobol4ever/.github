...
| Snocone Frontend Ladder | `GOAL-LANG-SNOCONE.md` | one4all+corpus | SC-24c DONE: claws5 one-phase clean port of Python claws_info; OPEN: pprint format mismatch in .ref files; SC-26 next (PAT.var capture bug); corpus HEAD 2b7caa6 | ☐ |
