...
| Goal | File | Repo | Step |
|------|------|------|------|
| SNOBOL4 Frontend Ladder | `GOAL-LANG-SNOBOL4.md` | one4all | SN-6b (SN-6a closed; --sm-run self-recursive patterns fixed via SM_PAT_REFNAME; expr_eval now byte-identical across --ir-run/--sm-run) |
