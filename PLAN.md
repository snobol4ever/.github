...
| Icon Frontend Ladder | `GOAL-LANG-ICON.md` | one4all | IC-9 (session #27, 2026-05-02: scan builtin infrastructure — move(n) OOM fix, tab/pos/rpos/bal new, any/many/upto explicit-args. PASS=13 unchanged; scan1 still FAIL pending E_SEQ conjunction fix + strchr→cset-bitmap for 8-bit safety.) |
