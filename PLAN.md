...
| **Snocone sm_lower (M2 path)** | `GOAL-SNOCONE-SM-LOWER.md` | corpus+one4all+.github | **NEXT: SL-11 (lower_proc_skeletons Ph3 or next rung).** SL-10 ✅ sess 2026-05-12 (Claude Sonnet 4.6): `lower_pat_expr` Ph2 complete — emit_pat_fn_args + emit_pat_capture + TT_CAPT_COND_ASGN/IMMED_ASGN/CURSOR + TT_DEFER cases. corpus `3579824`. |
