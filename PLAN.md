...
| **Prolog Frontend Ladder** | `GOAL-LANG-PROLOG.md` | one4all+corpus | **PR-14** (PR-13 rung36_arith_edge LANDED this session — mod/rem ISO semantics fixed, ^ integer power added. Next: rung37_term_ops ISO §7.6) |
