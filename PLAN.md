...
| **Prolog BB Complete (honest mode 3)** | `GOAL-PROLOG-BB-COMPLETE.md` | one4all+.github | **NEXT: PB-2 TT_CUT + PB-3 TT_TRAIL_MARK/UNWIND.** PB-0+PB-1 ✅ `f63a07cd` (Claude Sonnet 4.6): test_prolog_bb_honest.sh + TT_UNIFY → PL_UNIFY SM_CALL_FN. Honest baseline: 17/294 (--ir-run oracle). |
=======
