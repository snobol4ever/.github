...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-XVAL-DESCR EXVAL-1** — audit bb_box_fn call sites assuming σ/δ layout. EM-SPEC-T-ERADICATE ✅ closed (EST-1..4, sess 2026-05-12, `a2b65fb9`). Baseline: smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty PASS=9. one4all `a2b65fb9`. |
