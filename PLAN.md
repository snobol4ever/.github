...
| **BB Template Ladder — Icon + Prolog** | `GOAL-ICON-BB.md` | one4all+.github | **rt_bb_* DELETED** `0206b998` — all 10 C runtime Byrd-box functions gone, grep 0, build green, icon 198. **NEXT:** fill inline-x86 four-port bodies in hollow bb_pat_span/break/any/notany/bb_arbno/bb_capture.cpp PLATFORM_X86 arms; broker pattern rungs climb from RED. |
