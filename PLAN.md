...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **DAI-8 C6 ✅ 2026-05-18 (Sonnet 4.6, one4all `607b6aac`) — prolog_builtin.c dead-fn sweep. −75 LOC.** 15 functions + 14 header decls deleted. NEXT: DAI-8 cluster 7+ — remaining candidates: rt.c ~41, snobol4.c ~25, icon_runtime.c (frontend) ~12, icn_runtime.c (interp) ~10. |
