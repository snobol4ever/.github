...
| SNOBOL4 Frontend Ladder | `GOAL-LANG-SNOBOL4.md` | one4all | SN-17 IN PROGRESS: porter.sno under one4all ir/sm = 12,796/23,531 = 54.38% (SPITBOL = 100%, gap of 10,735 words); root cause is SN-6 Bug #1d (match-time vs commit-time `*fn()`); porter is now a clean quantitative gauge for Bug #1d progress. SN-16 DONE. SN-7 next: beauty.sno self-host bootstrap. SN-6 PASS=218/228 | ☐ |
