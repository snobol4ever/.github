...
| **Snocone-in-Snocone** | `GOAL-SNOCONE-IN-SNOCONE.md`   | one4all+corpus | SS-1 (placeholder — second-bootstrap-moment goal opened session 2026-05-02 #19. Write the Snocone compiler in Snocone. Goal file is intentionally near-empty; first session lays out the step plan.) |
