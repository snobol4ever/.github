...
| **PARSER-SNOCONE (pattern frontend)** | `GOAL-PARSER-SNOCONE.md` | corpus+one4all | PARSER-SC-5 (SC-4 ✅ session #67 cont.: function def + call landed; PASS=36 FAIL=0; 15 new fixtures) |
