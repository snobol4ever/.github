...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-19-binop-gen** — arith/relop with generative operand. Alternate ✅ `51460d4f` (+6). Limit ✅ `b7d74bf9` (+5). ir-run 149→164, honest 271→276. |
