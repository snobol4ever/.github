...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-11** (IJ-10 ✅ `88db975a`/corpus `3df52f6`: ICN_KW_SWAP frame-slot write + lhs/rhs order; rung36_jcon_subjpos PASS; ir-run 199/36, honest 270.) |
