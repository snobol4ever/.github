...
| SNOBOL4 Frontend Ladder | `GOAL-LANG-SNOBOL4.md` | one4all | SN-5 DONE (BEAUTY SELF-HOSTS 18/18); SN-6 next: re-run corpus (INTERP fix already in 53a0d101); ~203/228 IR expected | ☐ |
