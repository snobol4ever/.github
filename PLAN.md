...
| **Icon BB JCON triage** | `GOAL-HEADQUARTERS.md` | one4all+corpus+.github | **NEXT: IR-CD-5** — delete `ir_body` field; mode-4 standalone policy TBD. Then IR-CD-6/7. Also EC-UNI-3-beauty (byte-identity gate on beauty.sno) and **IR-RN-3..5** owed (IR-RN-1+2 ✅ `c710506f`+`92417a85`). Watermark `92417a85`. |
