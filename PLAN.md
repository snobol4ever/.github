...
| **SCRIP Head Quarters** | `GOAL-HEADQUARTERS.md` | one4all+corpus+(.github) | **PPV-9 NEXT** or **EC-UNI-22** (close / docs). REWIRE-ALL + NAMEKEY-BIN closed. emit_bb_x* switch-callers gone. one4all `0ef0f7fc`. GATE-PK PASS=411 FAIL=0 STUB=648. |
