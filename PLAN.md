...
| SNOBOL4 Frontend Ladder | `GOAL-LANG-SNOBOL4.md` | one4all | SN-6 IN PROGRESS: PASS=219/228; E_POW+callcap-union fixed; expr_eval blocked on XCALLCAP+RPOS cursor threading; HEAD 09261c1d | ☐ |
