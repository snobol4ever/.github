...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: RW-6** — delete old foundation files + shims; umbrella emit.h; finalize ARCH-EMITTER.md. RW-5 ✅ `e00a7c6f`. |
