...
| **⚡ sm_lower.c refactor (prereq for SL)** | `GOAL-SM-LOWER-REFACTOR.md` | one4all+.github | **NEXT: SR-3** — extract emit helpers (`emit_goto`, `expression_scope_walk`, `kw_canonicalize`) to `lower_ctx.c`. Closed: **SR-1 ✅ `f209b8d3`**, **SR-2 ✅ `daf27aeb`** — labtab_* family + GC migration. |
