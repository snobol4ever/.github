...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-13c or IJ-14** (IJ-13 partial `2d5567ca`: ast_gc_clone crash fixed; &input/&output return fh ints; write(fh,s) needs DT_FH typed descriptor. IJ-12 ✅ `6b20b4a2`. ir-run 200, honest 273.) |
...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-SNOCONE-PREP** — RW-6 ✅ complete: deleted emit_buf/emit_form/emit_label/emit_text3c/emit_insn/emit.c; absorbed into emit_mode.c+emit_label_new.c+emit_text.c+insn.c; emit_bb_gen.h → shim; all callers → emit.h. Gates smoke 7/7 byte-id 4/4 snocone 5/5. |
