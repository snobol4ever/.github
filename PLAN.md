...
| **Prolog BB** | `GOAL-PROLOG-BB.md` | one4all+corpus+.github | **PL-T-4..7 landed (8837b2b1)** — bb_pl_call/choice/alt/cut templates + rt helpers; IR_*→BB_* rename complete; .include bb_macros.s removed. OPEN: factorial Mode-4 segfault — BB_PL_CALL resume (bb_exec_resume on multi-clause predicate) crashes in BB_PL_SEQ backtrack pump. Debug PlCallSt trail/env in bb_exec.c. |
