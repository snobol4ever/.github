...
| SNOBOL4 Frontend Ladder | `GOAL-LANG-SNOBOL4.md` | one4all | SN-6 IN PROGRESS: PASS=203/228 broad; HEAD 7a752454; broker PASS=41; OPSYN root cause diagnosed: VARVAL_fn missing DT_N case → register_fn_alias gets NULL → fn=NULL → usercall_hook loop; fix: add case DT_N to VARVAL_fn in snobol4.c | ☐ |
