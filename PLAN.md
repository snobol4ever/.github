...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-6** (IJ-1..IJ-5 ✅ `8ecc814a`: cset canonical sort, entab/detab gap+type fixes, rung37_string_format; ir-run 198, honest 267) |
...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-7d** — beauty PASS=12/17. Pat-stack removed; PUSH_REAL fixed; _rt_IDENT/_rt_DIFFER fixed (NULVCL on success). one4all `b3afed64`, corpus `18ebc6d`. Remaining: tree_driver DIFFER guard; match_driver NRETURN inversion; stack_driver mode-2 bug. |
