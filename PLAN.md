...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-MODE4-IS-MODE3-DUMP-p (SM_CALL_FN).** Sess 2026-05-11 Sonnet 4.6 (one4all `36ca8ea0`): SM_JUMP+ARITH ported (-j,-l); SM_CONCAT/PUSH_NULL/COERCE_NUM (-n); SM_LABEL/SM_STNO (-o). t_* helper surface now 13 functions. Gates: smoke 7/7, template-byte-id 4/4. |
