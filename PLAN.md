...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: measure beauty PASS/17 with libscrip_rt** — Class A (stateful box zeta text fix: BAL/ARB/REM/BREAKX/LEN/TAB/RTAB/ICN_*) ✅ `fa75289f`; Class B (DEFINE_ENTRY frame fix) ✅ `fa75289f`; corpus sm_macros.s regen ✅ `65dad13`; broad corpus 113/113 PASS. |
