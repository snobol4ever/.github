...
| **⭐ DYNAMIC BYRD BOX** | DYN-50 | one4all `16e820a` · corpus `2f2bbe3` | **DYN-51**: word*/cross (&TRIM/INPUT) · expr_eval · locals/NRETURN/OPSYN/EVAL → ≥125p. Then MONITOR vs SPITBOL → 169p/9f. |
...
| **⭐ TINY JVM** | J-227 | one4all `68311b9` | **J-228**: pivot to boxes.jar API (refactor PatternBuilder+Interpreter) → verify 136p → ARRAY/TABLE → ≥155p |
