...
| **CLI 3-mode collapse + AST-interp delete** | `GOAL-CLI-3MODE.md` | one4all+.github | CLI-3M-1..7 ✅, CLI-3M-10 ✅ (2026-05-17j). **CLI-3M-9 partial ✅ 2026-05-18 (`188475d7`)** — `interp_exec.c` deleted (−378 LOC); `interp_eval.c` kept (live builtins dispatcher). NEXT: split `interp_eval` AST-walker out of `interp_eval.c` → CLI-3M-11 doc pass → CLI-3M-12. |
