...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-13** (IJ-12 ✅ `6b20b4a2`: static parent-frame fallback fixes recursive mutual conjunction / queens. ir-run 200, honest 272.) |
