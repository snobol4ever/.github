...
| **⚡ sm_lower.c refactor (prereq for SL)** | `GOAL-SM-LOWER-REFACTOR.md` | one4all+.github | **NEXT: SR-11** — lower_icn_gen (SUSPEND/TO/TO_BY/EVERY/LIMIT/ITERATE/ALTERNATE/MAKELIST) + lower_prolog (CHOICE/CLAUSE/CUT/UNIFY/TRAIL_MARK/TRAIL_UNWIND). Closed: SR-1..SR-9 ✅. **rename ✅ `cc21aa5a`** — sm_lower→lower, cohort_*→lower_*. **SR-9 ✅ `907644e5`** — icn_relop+cset+unary (24 kinds). **SR-10 ✅ `a4545102`** — lower_icn_ctrl (10) + lower_icn_data (5) + lower_icn_sect (4). Gate: PASS=30. |
