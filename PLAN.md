...
| **PARSER-SNOCONE (pattern frontend)** | `GOAL-PARSER-SNOCONE.md` | corpus+one4all | PARSER-SC-6 ⏳ (SC-6a ✅ landed PASS=46; SC-6b in progress — 1148 STMTs match oracle count; content diffs remain) |
