...
| **Prolog BB** | `GOAL-PROLOG-BB.md` | one4all+corpus+.github | **cd1599ac** — bb_pl_call/seq/alt/choice/cut honest stubs (graph-internal); RULES: no RT calls from BB templates. OPEN: rung03+ (compound unification, if-then) need lower_pl.c additions — previous attempt regressed crosscheck, needs careful fix. |
