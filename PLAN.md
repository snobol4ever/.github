...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-7d** — beauty PASS=14/17. rel8→rel32 fix (trace_driver ✅); rt_acomp DT_S coercion fix. Remaining: semantic_driver capture-fn (`epsilon . *PushCounter()` fires pattern but not capture); stack/counter pre-existing. one4all `c0675506`. |
