...
| **⚡ Icon BB Native (flat BB templates)** | `GOAL-ICON-BB-NATIVE.md` | one4all+.github | **NEXT: IB-0 — baseline + scaffolding.** Carved + arch clarified 2026-05-12 (Claude Sonnet 4.6). Boxes are x86 blobs via t_* template functions, one emit_bb_icn_* per construct. 10 rungs IB-0..IB-10, 7 gates each. SM_BB_PUMP at stmt level already correct — do not touch. Zeta allocated at runtime not emit time. |
...
| **Icon BB Complete (honest mode 3)** | `GOAL-ICON-BB-COMPLETE.md` | one4all+.github | ⛔ SUPERSEDED. See GOAL-ICON-BB-NATIVE. |
