...
| **⚡ Universal Generator IR** | `GOAL-LOWER-REDESIGN.md` | one4all+.github | **NEXT: LR-2** — ir_exec.h/c; LR-0 ✅ `bfe6ac9d` LR-3 ✅ `2ae6fe36` |
...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: SF-8/SF-12** (corpus gate + delete emit_bb_rtcall_data). All BBs flat `660e3ddb`; CLI --ast-run `0d21325f`. |
