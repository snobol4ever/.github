...
| **⚡ PST: Raku** | `GOAL-PST-RAKU.md` | one4all+corpus+.github | **⏳ Phase 1 NOT clean** — 4 §⛔ violations remaining (R19 gather-splice, R27 gather-hoist, PRF-13 Phase 2 mirror, PST-FIELD). one4all `5047950e`, corpus `a9b1240`. NEXT: PRF-12-gather-splice (R19) — verify gather child-stealing clean, then PRF-12-gather-hoist (R27). ⚠ Always regen `raku.tab.c` after any `raku.y` change. |
