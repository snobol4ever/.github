...
| **⚡ PST: Raku** | `GOAL-PST-RAKU.md` | one4all+corpus+.github | Phase 1 C ✅. PRF-13 REVERTED (assign+shift wrong). **PRF-14 ready** — full rewrite: read semantic.sc + parser_snocone.sc + parser_snobol4.sc + raku.y first, derive approach, then rewrite from scratch. corpus @ 8dea9a9. |
