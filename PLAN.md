...
| **PARSER-SNOBOL4 (pattern frontend)** | `GOAL-PARSER-SNOBOL4.md` | corpus+one4all | PASS=78/78 ✅ corpus@ebb9b72 — iter#2/3 whitespace-token canonicalization ($'  '/$' ' form). Next: SN-7-8 beauty.sno crosscheck or PARSER-FAMILY-LOOP next iteration. |
