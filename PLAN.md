...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-SPEC-T-ERADICATE EST-2** — migrate rt.c + bb_boxes.c spec_t locals to DESCR_t. Closed: EM-BB-FORMAT-ARCH ✅ + EM-BB-FORMAT-1/2/3 ✅ (`cd0b5964`). EM-BB-FORMAT-4/5/6/7/8/9 ✅ (`b6f236e6`, `69734bb3`). EM-BB-FORMAT ✅ closed. EST-1 ✅ audit complete (sess 2026-05-12). Baseline: smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty PASS=9. one4all `b0d93f7a`. |
