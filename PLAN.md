...
| SNOBOL4 Frontend Ladder | `GOAL-LANG-SNOBOL4.md` | one4all | SN-6 IN PROGRESS: PASS=215/228; ARBNO+DATA SM/JIT fixed; next: ITEM builtin, ARRAY/TABLE, demo suite; HEAD d3ef8ec2 | ☐ |
