...
| **⚡ PST: Parent (HQ coordination)** | `GOAL-PARSER-PURE-SYNTAX-TREE.md` | one4all+corpus+.github | **PST-LR-AUDIT-1** scans 1–6 ✅ (51 §⛔ violations: 11 Snocone, 1 Icon, 2 SNOBOL4, 27 Raku, 6 Rebus, 4 Prolog). 1h/1i/1j pending. Phase 1 marked ⏳ for **all six** parsers. Six per-language rows below. |
