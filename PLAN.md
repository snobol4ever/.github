...
| **PARSER-SNOBOL4 (pattern frontend)** | `GOAL-PARSER-SNOBOL4.md` | corpus+one4all | PARSER-SN-6 LANDED (PASS=58); PARSER-SN-7 REWRITE-0 PARTIAL-LANDED (corpus@8083c20, MVP PASS=4/5); next REWRITE-1 — Stmt assign body |
