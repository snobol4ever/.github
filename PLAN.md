...
| **Snocone sm_lower (M2 path)** | `GOAL-SNOCONE-SM-LOWER.md` | corpus+one4all+.github | **NEXT: SL-13.** SL-12 ✅ sess 2026-05-12 (Claude Sonnet 4.6): EVAL(*expr) special case in lower_fnc — thunk + patch SM_PUSH_EXPRESSION→SM_CALL_EXPRESSION. corpus `e408c87`. |
