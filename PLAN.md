...
| Goal | File | Step |
|------|------|------|
| **ICON-BB** | `GOAL-ICON-BB.md` | LFJ-0 ✅ (`bc7dae2a`: LOWER-IRGEN-MAPPING.md committed). **LFJ-1a-i** ✅ (`f79ea9ba`: 9 leaf cases extracted — ILIT/FLIT/QLIT/CSET/VAR/KEYWORD/LOOP_BREAK/LOOP_NEXT/PROC_FAIL → lower_icn_legacy_<KIND> static fns; switch arms collapsed to one-line dispatches; ZERO logic change). Next: **LFJ-1a-ii** — extract next batch of case bodies. Gates: smoke 5/5, broker 24, rungs 198, smoke_prolog 5/5. |
