...
| Raku Frontend Ladder | `GOAL-LANG-RAKU.md` | one4all | RK-32 next: BB-native NFA RE engine (integrate Lon NFA code); Phases 4-7: NFA/captures/code-asserts, file I/O, BB grammar machine, GDE features | ☐ |
