...
| **⚡ PST: Rebus** | `GOAL-PST-REBUS.md` | one4all+corpus+.github | PST rewrite 5a–5g ✅. Active: **5h** (subsystem suite to 19/20 — currently 15/20 at HEAD), then **5i** (parser AST dumps match `--dump-ast` C ref), **5j** (6-fn trace), **5k** (Snocone INCLUDE). SL-2 closed; SL-3/4/5 open. |
