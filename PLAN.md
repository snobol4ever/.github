...
| Snocone Frontend Ladder | `GOAL-LANG-SNOCONE.md` | one4all+corpus | SC-24b next: claws5.sc (after SC-24c two-phase + SC-26 fix); SC-24 done: claws5.sno stdin rewrite, fresh ref, both oracles match; SC-24c+SC-25 added; OPEN BUG: treebank-append parse_fail | ☐ |
