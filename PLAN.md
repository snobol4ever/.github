...
|---------|--------|------|----------------|
| **SNOBOL4 × x86** | BEAUTY | one4all `b359abc5` · corpus `3fd44d0` · INTERP=./scrip PASS=169/203 | B-1 ✅ B-2 ✅ · **NEXT: B-3** isolate remaining `snobol4:0: parse error` in beauty self-hosting → Error 5 stmt 527 goes away → beauty output matches csnobol4 |
