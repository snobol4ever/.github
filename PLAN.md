...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-DOPPELGANGER-PURGE EDP-4 — sm_codegen_x64_emit.c reduced to dispatch.** EDP-3 ✅ sess 2026-05-12k (Claude Sonnet 4.6, one4all `ed41f343`): sm_codegen.c if-else → clean switch; baseline smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty-subsystems PASS=7. |
