...
| **SNOBOL4 JS** | SJ-8 | one4all `5f0f36a` · corpus `18a8b70` | **SJ-9 FIRST**: DEFINE/RETURN call stack (sno_engine.js) → fixes 1010–1018 timeouts. Then DATA/ARRAY/TABLE. Gates: emit-diff **175/0** · invariants **52p/68f**. |
