...
| **⭐ TINY JVM** | J-218 | one4all `7c35456` | **M-JVM-A02**: review bb_seq.java β + bb_arbno.java stack · fix E_IDX 2D subscript write path (~2658 emit_jvm.c) · global driver diff clean → ≥100p. bb_*.java (29 files) landed J-217 in src/runtime/boxes/. See MILESTONE-JVM-SNOBOL4.md. |
