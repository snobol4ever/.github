...
| **⚡ PST: Icon + Raku** | `GOAL-PST-ICN-RAKU.md` | one4all+corpus+.github | **DONE ✅ 2026-05-18** — Icon 0/0 (corpus@3789cba) + Raku 0/0 (corpus@78c1b4a). Both sidecars deleted. push_interp_str/dq_unescape/finish_* inlined into parser_raku.sc; Finish_* aliases → (epsilon . *finish_*()); Push_ilit(n) → shift_val(n,'TT_ILIT'); Store_for_iter → shift_val(capff capfr,'TT_VAR'). semantic.sc: shift_val() added. |
