...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: SF-8/SF-12** (corpus gate + delete emit_bb_rtcall_data). All box types now flat-eligible `660e3ddb`. |
