...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-BB-MACROS-0 — add t_bb_is_text_mode + t_bb_text_port helpers.** EDP-3 ✅ `ed41f343`; --bb-macros flag wired `ec334068` (sess 2026-05-12l). EM-BB-MACROS rungs 0–9 documented. Baseline smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty-subsystems PASS=7. |
