...
| **⚡ PST: Raku** | `GOAL-PST-RAKU.md` | one4all+corpus+.github | **⏳ Phase 1 NOT clean** — 19 §⛔ violations remaining. PRF-12-say/print/sub/die/arr-hash-ops/class/program ✅. one4all `2fed81d3`, corpus `47a8845`. NEXT: PRF-12-for (R12-13) or PRF-12-try (R10). ⚠ Always regen `raku.tab.c` with `bison -d raku.y -o raku.tab.c` after any `raku.y` change. |
