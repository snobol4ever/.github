...
| **⚡ PST: Rebus** | `GOAL-PST-REBUS.md` | one4all+corpus+.github | **⏳ Phase 1 NOT clean** per `PST-LR-AUDIT.md § Scan 5` — 6 §⛔ violations. RB-C-1 ✅. Active: **RB-C-2/3/4/5** (audit-promoted) + **PST-RB-DECL-1..5** (eliminate `RDecl`/`RCase`/`RProgram` outer wrapper — all info passes inside tree, no side hustles, per Lon 2026-05-19). PST-RB-PRE-BEAUTY Bug #1 ✅ 2026-05-17; Bug #2 sketched, untested. |
