...
| **Snocone sm_lower (M2 path)** | `GOAL-SNOCONE-SM-LOWER.md` | corpus+one4all+.github | **NEXT: SL-9 test driver + .ref.** SL-8 ✅ sess 2026-05-12 (Claude Sonnet 4.6): lower() confirmed complete — proc_skeletons stub + stmt walk + labtab_resolve + SM_HALT guard all present. Gate passes (6 SM instrs, diff clean). |
