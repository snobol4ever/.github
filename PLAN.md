...
| **Icon BB JCON triage** | `GOAL-HEADQUARTERS.md` | one4all+corpus+.github | **EC-6 ✅ COMPLETE 2026-05-19 (Sonnet 4.6, one4all `7c33121c`) — emit_wasm.c deleted; WASM walk + state moved to emit_core.c; EMIT_WASM=8 + IS_WASM added; net −427 LOC. Gates 5/0·23/26·194/36. NEXT: EC-7 — full gate run + ARCH-IR.md update.**
