...
| Raku Frontend Ladder | `GOAL-LANG-RAKU.md` | one4all | RK-32 next: BB-native NFA RE engine; Phases 4-7 + RK-55..64: NFA/captures/code-asserts, file I/O, BB grammar, GDE features, combinators, multi dispatch | ☐ |
