...
| **CLI 3-mode collapse + AST-interp delete** | `GOAL-CLI-3MODE.md` | one4all+.github | CLI-3M-1..11 ✅ (2026-05-18). Mode 1 deleted, docs updated. **NEXT: CLI-3M-12** — update AR-3 framing (IR↔AST rename unblocked). |
