...
| **⚡ PST: Rebus** | `GOAL-PST-REBUS.md` | one4all+corpus+.github | **DONE** PST-RB-5a-5e ✅; PST-RB-5g ✅ 2026-05-17 (opnames[] + lower_name fixes — Snocone subsystem suite 13/20 → 15/20). SL-2 closed; SL-3/4/5 open. Next: write SPITBOL oracle tests for the 5 remaining subsystem failures (match, Gen, semantic, trace; Qize blocked by SL-3) before any SCRIP changes. Then 6-function trace (shift/reduce/nPush/nInc/nTop/nPop) on parser_*.sc. See State `findings-5g`. |
