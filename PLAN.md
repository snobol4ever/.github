...
| **✅ sm_lower.c refactor (prereq for SL)** | `GOAL-SM-LOWER-REFACTOR.md` | one4all+.github | **COMPLETE** — SI-1..SI-10 all closed. one4all `508b2324`. Unlocks GOAL-SNOCONE-SM-LOWER (SL-1). |
