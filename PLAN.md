...
| **Icon BB JCON triage** | `GOAL-HEADQUARTERS.md` | one4all+corpus+.github | **EC-UNI-0..2d ✅; EC-UNI-3 partial 🔄 (42908963); EC-UNI-8 ladder added; EC-UNI-8.1 ✅ (573bc63c, regrouped from 57 to 10 themed files); EC-UNI-8.2 ✅ (eca7cc34); EC-UNI-8.3 partial 🔄 (matrix gate live; 213 misses tracked).** 10 themed SM_templates files + 16 BB_templates files; full backend × mode matrix landed; machine-checked gate scripts/test_gate_em_template_matrix.sh. Gates floor flag-off and flag-on. **NEXT: EC-UNI-3-beauty** (byte-identity gate on beauty.sno) or **8.3-fixup** (hand-fix 4 sm_pat_* one-liners to drop matrix misses).
