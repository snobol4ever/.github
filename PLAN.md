...
| SNOBOL4 Frontend Ladder | `GOAL-LANG-SNOBOL4.md` | one4all | SN-16 DONE: Porter (1980) stemmer demo in corpus/demo (100% vs tartarus oracle, 23,531 words); SN-7 next: beauty.sno self-host bootstrap under --ir-run, all 18 driver×mode combos diff=0; SN-6 IN PROGRESS: PASS=218/228; Bug #1d open | ☐ |
