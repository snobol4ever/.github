...
| **PARSER-RAKU (pattern frontend)** | `GOAL-PARSER-RAKU.md` | corpus+one4all | PARSER-RK-4.5 (style refactor to beauty.sc shape — 7 sub-steps 4.5-a..4.5-g; recommended, not gating; OR skip to RK-5 if regex is the priority) |
