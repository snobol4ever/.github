...
| **⭐ DYNAMIC BYRD BOX** | DYN-59 | one4all `1c9dff0` · corpus `2f2bbe3` | **DYN-60**: fix `<BODY>\n` depth guard (suppress T_STMT_END when depth>0) → word3/4/wordcount ≥158p; then 310/311/312; then W04_arbno |
