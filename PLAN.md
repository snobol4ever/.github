...
| **⭐ Scrip Demo** | SD-17: M-SD-DEMO7 ✅ — demo7/caesar.md; REPLACE-parallel-strings/map()/maplist-codes | `137364c` SD-17 | M-SD-DEMO8 |
...
`M-SD-DEMO1` ✅ · `M-SD-DEMO2` ✅ · `M-SD-DEMO3` ✅ · `M-SD-DEMO4` ✅ · `M-SD-DEMO5` ✅ · `M-SD-DEMO6` ✅ · `M-SD-DEMO7` ✅ · `M-SD-DEMO8` ❌ **NEXT** (sort) · `M-SD-DEMO9` ❌ (rpn) · `M-SD-DEMO10` ❌ (anagram)
