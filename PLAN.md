...
| **SNOBOL4 JS** | SJ-6 | one4all `2d907b7` | **SJ-7 FIRST**: fix emit_js.c block-grouping bug (triple-START, f09). Then DEFINE/RETURN runtime. Bench: 1.4×–64.9× vs spipatjs (all 8 wins). Feat 14/17. |
