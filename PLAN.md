...
| **SNOBOL4 WASM** | SW-17 | `fdcd636` one4all | **M-SW-BYRD**: rewrite emit_wasm.c statement+pattern as full Byrd-box tail-call WAT — see MILESTONE-WASM-BYRD.md. SW-18 first action. |
