...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: re-apply lower.c DEFINE_ENTRY labtab fix (sess 2026-05-12d) + diagnose BB-blob R10 corruption at bb_broker:44. TC-UNSPLIT-3/5/9/10/11/CLOSE ✅ sess 2026-05-12f (Claude Opus 4.7): all five bundle files (sm_var.c, sm_label_stno.c, sm_pat_lbl.c, sm_pat_capture.c, sm_pat_capture_fn.c) are source of truth; 4 orphan per-op files deleted; Makefile updated; baseline preserved. File count 93→89. Gates: smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty-subsystems mode4 PASS=6 FAIL=11. one4all `c074dd7e`.** |
