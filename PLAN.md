...
| **Snocone-in-Snocone** | `GOAL-SNOCONE-IN-SNOCONE.md`   | one4all+corpus | SS-2 (SS-1 DONE — step plan written, architecture decided: Stage 0 = scrip C host, Stage 1 = snocone.sc self-compiles. 7-file layout in interpreter/. TDD ladder SS-2..SS-15. Next: value.sc DESCR representation.) |
