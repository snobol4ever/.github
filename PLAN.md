...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **DAI-8 C14 ✅ 2026-05-18 (Sonnet 4.6, one4all `50e025f6`) — icon_runtime+sm_interp+sm_jit_interp+stmt_exec 20 fns −168 LOC.** NEXT: DAI-8 C15 — lex.rebus/scrip_ir/bb_pool/ast_clone/lower audit. |
