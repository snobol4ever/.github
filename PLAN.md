...
| Snocone Frontend Ladder | `GOAL-LANG-SNOCONE.md` | one4all+corpus | SC-26 next: fix (PAT . var) . *fn(var) arg eval order in pattern engine; treebank pp_node DONE (pprint-exact, zero diff); corpus HEAD 1ddb066 | ☐ |
