...
| **⭐ DYNAMIC BYRD BOX** | DYN-75 | one4all `c5560a9` · corpus `8d5cc6a` | **177p/1f** · **DYN-76**: fix expr_eval callcap-flush δ=0 for recursive constant match → **178p/0f → M-DYN-INTERP-FULL** |
