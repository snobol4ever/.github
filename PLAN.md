...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-12** (IJ-11 ✅ `9681072c`/corpus `418ed33`: icn_kw_read() infra; type()/image()/size cset fixes; named-cset registry; &error/trace/dump/random r/w; &fail passthrough; rung37_keywords ✅ honest 270→271. Residual XFAIL: generative &allocated/collections/features/regions/storage/progname.) |
