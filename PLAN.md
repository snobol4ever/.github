...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-BB-3 Group G or assign/scan fix** (E-augop ✅ `a40e4791`; H-sections ✅ `767d9a2d`; coro_drive→icn_drive rename ✅; ir-run 191, honest 276) |
...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: SF-7** — SF-6 ✅ `8a63e515` ICN_* boxes sized DATA blocks. SF-5 ✅ `55857945` BREAKX flat. SF-4 ✅ `98b2e204` LEN/TAB/RTAB. SF-3 ✅ REM. SF-2 ✅ ARB. SF-1 ✅. S200 done. beauty 10/17. |
