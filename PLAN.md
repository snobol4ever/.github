...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-7d** — `--jit-emit beauty.sno` passes SPITBOL oracle. EM-XVAL-DESCR + EM-S-ARTIFACTS-COMMIT ✅ (sess 2026-05-12, one4all `b8ef6b18`). Baseline: smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty PASS=9. |
