...
| **SCRIP Head Quarters** | `GOAL-HEADQUARTERS.md` | one4all+corpus+(.github) | **one4all HEAD=`41e629e3`**. SJ-1a ✅ SJ-1b funnel rework + six-function API ✅ (emit_1/2/3asm + emit_L2/3/4asm + emit_directive; pilot proven). GATE-PK 419/0/635. **NEXT: SJ-1b-sweep** — route ALL backends' ASM through funnels, per-backend-atomic, start x86. |
