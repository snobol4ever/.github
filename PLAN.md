...
| Goal | File | Step |
|------|------|------|
| **ICON-BB** | `GOAL-ICON-BB.md` | LFJ-0..LFJ-1a-iv ✅. **LFJ-1a-v** ✅ (`092f7862`: TT_GLOBAL/LOCAL/STATIC_DECL (3-label shared), TT_INITIAL, TT_RETURN, TT_SUSPEND, TT_IDENTICAL, TT_NONNULL, TT_NULL, TT_RANDOM, TT_MATCH_UNARY, TT_MNS, TT_PLS, TT_CSET_COMPL, TT_CSET_UNION/DIFF/INTER (3-label shared) → 13 lower_icn_legacy_<KIND>* static fns; ZERO logic change). Next: **LFJ-1a-vi** — extract TT_SIZE, TT_IDX, TT_SECTION/SECTION_PLUS/SECTION_MINUS, TT_CASE, TT_FIELD, TT_RECORD, TT_MAKELIST, TT_ITERATE. Final 1a sub-rung — mega-switch becomes a pure dispatcher. Gates: smoke 5/5, broker 24, rungs 198, smoke_prolog 5/5. |
