...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EC-1 — Restore missing runtime BB box functions** (EDP-12 ✅ `a21a6e19`, EM-DOPPELGANGER-PURGE closed). Baseline: smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty-subsystems PASS=11. |
