...
| **PARSER-ICON (pattern frontend)** | `GOAL-PARSER-ICON.md` | corpus+one4all | PARSER-IC-10 (IC-9 LANDED PASS=51 corpus@85c14d0 — augmented assigns + unary prefix + power; new "Style guidelines — derived from beauty.sno / beauty.sc" section in goal file codifies beauty conventions for all PARSER-* authors; IC-10-style sub-rung enumerates current parser_icon.sc guideline violations to remediate) |
