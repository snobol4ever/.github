...
| SNO treebank-list | `GOAL-SNO-TREEBANK-LIST.md` | one4all | TL-1 DONE (landed via C5 session HEAD 6ee09b7f); TL-2 next | ☐ |
| SNO claws5 | `GOAL-SNO-CLAWS5.md` | one4all | C5-2 next: ARBNO first-iteration empty captures; bb_arbno save/restore bug; HEAD 6ee09b7f | ☐ |
