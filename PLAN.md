...
| **Snocone sm_lower (M2 path)** | `GOAL-SNOCONE-SM-LOWER.md` | corpus+one4all+.github | **NEXT: SL-12.** SL-11 ✅ sess 2026-05-12 (Claude Sonnet 4.6): `emit_thunk` + `lower_defer` — SM_PUSH_EXPRESSION path; emit_pat_fn_args non-literal fix; fmt_instr SM_PUSH_EXPRESSION display. corpus `1620344`. |
