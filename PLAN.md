...
| **PARSER-ICON (pattern frontend)** | `GOAL-PARSER-ICON.md` | corpus+one4all | PARSER-IC-4 (IC-3 landed PASS=20 — control flow + comparison ops; TDump multi-line bug fixed in shared lib) |
