...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-8** (IJ-7 ✅ `b50d8180`: to-by real truncation, CSETVAL image, cset int/real ops, ^ neg-int; rung36_jcon_coerce+numeric PASS; ir-run 198, honest 267, broker 23) |
