...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-19-remaining** — TT_SUSPEND (blocked CH-17g); rung32; rung36 suite. ir-run 192→199 (+7), honest 273, broker 23/49. Fixes: IR_ICN_TO_NESTED; trim; seq; icn_drive_node accumulation; icn_bb_mutual (A&B); TT_NONNULL empty-str; loop_next/break in IR_ICN_EVERY. one4all 37ff6d70. |
