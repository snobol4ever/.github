...
| Goal | File | Repo | Step |
|------|------|------|------|
| **CHUNKS — Eliminate SM_PUSH_EXPR** | `GOAL-CHUNKS.md` | one4all+.github | **CH-17i-bang-concat Phases 2/3/4 ✅ SEQUENCED 2026-05-10 behind CH-17g-irrun-execution** — 706-program audit (Icon 271 + Raku 186 + Snocone 114 + Prolog 135) reports zero SM_PUSH_EXPR fires today; doc `CHUNKS-step17i-bang-concat-phase234-audit.md`. Phase 1 ✅ 2026-05-10 (one4all `a8a064a0`). The deferred phases are **required for Mode 4 on Icon/Prolog** (emitted binaries cannot tree-walk); same basis applies to sister rungs CH-17i-section, CH-17i-limit-random. Next inline: **CH-17g-irrun-execution** (the architectural unblock for the whole Mode 4 ladder), or pivot to CH-17i-prolog-initialization (concrete one-file change with `coverage_net_gaps.pl` anchor). |
| **CHUNKS Step 17** | `GOAL-CHUNKS-STEP17.md` | one4all+.github | **CH-17i-bang-concat Phases 2/3/4 sequenced** (same as above) |
