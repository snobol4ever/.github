...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: RW-1** — EM-REWRITE plan written (sess 2026-05-13z). 11-step multi-session full emitter rewrite. RW-1: new `insn.h/insn.c` leaf layer alongside old code. |
