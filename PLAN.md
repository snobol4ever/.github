...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-XVAL-DESCR EXVAL-2** — add descr_match_span/descr_bool constructors; update SNOBOL4/Prolog box returns. EXVAL-1 ✅ closed (sess 2026-05-12, `799f8492`). Baseline: smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty PASS=9. one4all `799f8492`. |
