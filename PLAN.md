...
| **⚡ PST: Raku** | `GOAL-PST-RAKU.md` | one4all+corpus+.github | **⏳ Phase 1 NOT clean** — 5 §⛔ violations remaining (R19/R26/R27 + PST-FIELD-1/2 cleanup). one4all `088ac03c`, corpus `b31045b`. NEXT: PRF-12-twigil (R26), PRF-12-gather-splice (R19), PRF-12-gather-hoist (R27). ⚠ Always regen `raku.tab.c` with `bison -d raku.y -o raku.tab.c` after any `raku.y` change. |
