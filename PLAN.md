...
| **BB Template Ladder — Icon + Prolog** | `GOAL-BB-TEMPLATE-LADDER.md` | one4all+corpus+.github | ICN-T-2 ✅. Phase F done: F-6a/b/c ✅, F-6d partial `bd6b0917` (BINOP/ARITH/UNIFY/BUILTIN/PL_ALT → α/β ports). Phase G (eradicate BB_t.c[]/n, add lhs/rhs/operand) in GOAL-ICON-BB.md. **NEXT: G-1** — add lhs/rhs/operand to BB_t struct. Rungs 153 (recovers ≥169 at G-4e). |
