...
| **Icon BB JCON triage** | `GOAL-HEADQUARTERS.md` | one4all+corpus+.github | **EC-5 ✅ COMPLETE 2026-05-19 (Sonnet 4.6, one4all `e1c8a4ac`) — emit_jvm.c/emit_js.c/emit_net.c/emit_ir.c/emit_ir_targets.c deleted; IR walk + SM walks moved to emit_core.c; unified emit_program(); IR_emit_vtable_t deleted; net −2077 LOC. Gates floor 5/0·23/26·194/36. NEXT: EC-6 — delete emit_wasm.c, move WASM walk to emit_core.c.**
...
| **⚡ PST: Raku** | `GOAL-PST-RAKU.md` | one4all+corpus+.github | Phase 1 C ✅. **Phase 2 PRF-14 ✅ COMPLETE** (2026-05-19, Opus 4.7). Full rewrite from scratch, 426 LOC, mirrors raku.y exactly (116 RHS / 27 non-terminals). ⚠ MIRROR-GAP-PRF-14-5: smoke blocked by container &ALPHABET segfault (same as PST-SC-SC-5). |
