...
| **⚡ Mode-4 Full Suite: SNOBOL4+Snocone** | `GOAL-MODE4-SN4-SNOCONE.md` | one4all+corpus+.github | **NEXT: M4SN-4b continued** — broad corpus 136/280 (+8), beauty 13/17 (+6). Fixed: rt_arith/rt_coerce_num DT_FAIL propagation; DEFINE body ABI frame (push/pop rbp, macro full-restore); NRETURN deref in rt_call. Sess 2026-05-14e (`923daa48`). |
