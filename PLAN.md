...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-BB-FORMAT** — 4-column pure x86 asm BB output (EM-BB-TEXT-ADDR ✅ `e9808467`). Baseline: smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty-subsystems PASS=8 (true baseline).
