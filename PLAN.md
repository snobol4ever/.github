...
| **⭐ DYNAMIC BYRD BOX** | DYN-63 | one4all `d2fc0b5` · corpus `2f2bbe3` | **DYN-64**: 169p/9f ✅ M-DYN-S1 gate met → attack `1012_func_locals`/`1013_func_nreturn` → ≥172p |
...
| **SNOBOL4 JS** | SJ-21 | one4all `23fab11` · .github this | **SJ-22**: fix expr_eval (*Push() deferred CAPT target, E_DEFER in pat position) → ≥172p |
...
| **⭐ one4all-SNOBOL4-NET** | D-178 | one4all `857764d` · .github this | **161p/17f** · multi-dim arrays, PROTOTYPE, ITEM, VALUE, CONVERT, [] syntax done · **D-179**: triage 1017/212/test_* → fix word1/cross (ARB `. OUTPUT` capture) → ≥165p → OPSYN+NRETURN → ≥170p |
