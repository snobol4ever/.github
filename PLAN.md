...
| **SNOBOL4 Pattern BB** | `GOAL-SNOBOL4-BB.md` | one4all+corpus+.github | SBL-ANY/NOTANY/SPAN/BREAK/CAPTURE TEXT arms ✅ + lower_flat_invariant ASSIGN_IMM/COND inclusion ✅. Rung suite M4 1→8, broad corpus 137→155 (+18). **NEXT: SBL-ARBNO** (six SKIP-M4 rungs still gated). Then BREAKX β, then BINARY arms, then ATP kind. Mode-2 unchanged 7/7; GATE-PK still stale (baseline refs deleted rt_bb_*). |
