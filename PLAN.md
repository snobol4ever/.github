...
| NET Beauty Self-Host | `GOAL-NET-BEAUTY-SELF.md` | snobol4dotnet | S-2 IN PROGRESS: crash at BuildMain (Data.cs:206) not match time; PatternVar passed to treeNode field accessor during pattern construction; next: harden Data.cs:206 else-branch to FRETURN; HEAD dcf6457 beauty 17/17 | ☐ |
