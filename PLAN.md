...
| Snocone Frontend Ladder | `GOAL-LANG-SNOCONE.md` | one4all+corpus | SC-26 next: fix (PAT . var) . *fn(var) arg order in pattern engine; SC-24b done: claws5.sc goto-free; treebank-prepend/append renamed to treebank-list/array | ☐ |
