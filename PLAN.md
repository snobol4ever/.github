...
| **⭐ DYNAMIC BYRD BOX** | DYN-76 | one4all `7a64880` · corpus `8d5cc6a` | **177p/1f** · **DYN-77**: fix CC_γ_core side-effect timing — defer Push() call to flush_pending_callcaps → stk[0] correct → expr_eval → **178p/0f → M-DYN-INTERP-FULL** |
