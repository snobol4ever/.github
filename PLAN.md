...
| **⚡ Prolog BB JCON triage** | `GOAL-PROLOG-BB-JCON.md` | one4all+corpus+.github | **NEXT: PJ-5/6 fix** — add `IR_PL_ALT` kind (inline disjunction, drives c[0]/c[1] as IR_t* directly); change ';' in lower_pl_stmt_node to emit IR_PL_ALT not IR_PL_CHOICE. After fix: main/0 with ';' lowers → smoke_prolog 5/5. Watermark `7be007c2`: smoke_prolog 3/5. **PJ-1..4 ✅** (`d9fe1496` `f5db4e5f` `cb1417a5`). PJ-5/6 WIP. |
