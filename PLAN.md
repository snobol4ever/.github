...
| **⚡ PST: SNOBOL4** | `GOAL-PST-SNOBOL4.md` | one4all+corpus+.github | **PST-SN4-W1 ✅** 2026-05-18. Audit 2026-05-19 (`PST-LR-AUDIT.md`) surfaced **W2 (goto_expr mutate-in-place, canonical §⛔ violation), W3 (g_cur mid-rule tree mutation in expr15/expr17).** SNOBOL4 NOT Phase 1 clean. |
| **⚡ PST: SNOBOL4 + Snocone** | `GOAL-PARSER-PURE-SYNTAX-TREE.md` | one4all+corpus+.github | **Active HQ rung: PST-LR-AUDIT-1** — per-production audit of all six C parsers; **scans 1–6 ✅** (51 §⛔ violations total: 11 Snocone, 1 Icon, 2 SNOBOL4, 27 Raku, 6 Rebus, 4 Prolog); sub-steps 1h (second-pass verify), 1i (rung cross-check), 1j (rung promotion) pending. **Also active: PST-SC-4k** (Snocone goto→TT_GOTO_U). Phase 1 marked ⏳ for **all six** parsers per audit findings. |
...
| **⚡ PST: Prolog** | `GOAL-PST-PROLOG.md` | one4all+corpus+.github | **parser_prolog.sc mirror** — C rungs 6a–6g ✅ 2026-05-18. C side clean. SCRIP mirror work next (read SNOBOL4-SNOCONE-PRIMER.md first). |
