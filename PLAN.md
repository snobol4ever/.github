...
| SNOBOL4 Frontend Ladder | `GOAL-LANG-SNOBOL4.md` | one4all | SN-6 IN PROGRESS: PASS=218/228; Bug #1c (NAM_commit callcap wrote DT_N not matched text) FIXED in snobol4_nmd.c; Bug #1d localized: expr_eval `2+3`→`PATTERN`, DT_P leaks onto pattern stack via *expr/*Binary; smoke PASS=7, broker PASS=49 | ☐ |
