...
| **Style: 200-col emitter reformat** | `GOAL-STYLE-200COL.md` | one4all+.github | **NEXT: S200-2** — remaining headers. S200-1 ✅ `0ce4080a`. Rules in RULES.md § "C code style — 200-character line width". |
