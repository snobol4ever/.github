...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: sub-rung -i (BB-axis: bb_xbrkx).**  -h ✅ sess 2026-05-11 (Claude Sonnet 4.6, one4all `87f59f43`): sm_void_pop template; call rt_pop_void@PLT. Byte-identical.  -g ✅ sess 2026-05-11 (Claude Sonnet 4.6, one4all `9e2ea80e`): bb_xlnth/xtb/xrtb integer-cursor template. Byte-identical.  -f ✅ sm_push_lit_i. -e ✅ charset. -c ✅ Option C. |
