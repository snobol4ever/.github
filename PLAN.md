...
| **Icon BB JCON triage** | `GOAL-HEADQUARTERS.md` | one4all+corpus+.github | **IR-RN-0 ✅ COMPLETE 2026-05-20** (builder/consumer rename: IR_t→BB_t, SM_Program→SM_sequence_t, ~100 tags IR_*→BB_*, IR builders UPPERCASE, SM builders UPPERCASE, consumers lowercase). 3 sed passes, 48 files, 4 scripts. Build green, hello OK, smoke icon 5/0. **NEXT: IR-RN-1** (audit lower.c post-rename). Then IR-RN-2/3 (emitter + runtime audits). Then back to EC-UNI-3-beauty.
