...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-14** (IJ-13c ✅ `1e4a6d7f`: DT_FH typed descriptor; write/writes/read/reads/close/open route via FHVAL; honest 273→274. ir-run 200, honest 274.) |
