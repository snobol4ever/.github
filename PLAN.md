...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-9** (IJ-8 ✅ `340bccc3`: bb_strrel int/real coerce + string return; rung37_str_relop; ir-run 198, honest 268, broker 23) |
