...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-BB-FORMAT** — sess 2026-05-13p: emit_sm_gen.c dropped (−2451 lines dead duplicate). one4all `0d2818ad`. Gates: smoke 7/7, byte-id 4/4, em8 5/5. |
