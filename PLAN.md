...
| **⚡ Universal Generator IR** | `GOAL-LOWER-REDESIGN.md` | one4all+.github | **NEXT: LR-S2** — delete bb_node_t path; prereq: fix pattern-var deref bugs OR implement IR_PAT_DEREF. LR-S1b ✅ `0c84d492` broad corpus 161/280. renames ✅ `92213ee1`; reorg ✅ `553a836a` |
