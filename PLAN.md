...
| **⚡ PST: Snocone** | `GOAL-PST-SNOCONE.md` | one4all+corpus+.github | **⏳ Phase 1 NOT clean** — 2 §⛔ violations remaining. 4k–4l ✅ 4m ✅ 4n ✅ FLATTEN ✅ LABELS ✅ `6a880716`. Active: **PST-SC-RET-IN-FN** (emit one TT_RETURN($expr) not two synthesized stmts). |
