...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-BB-FORMAT-1** — 4-column pure x86 per-port BB output (EM-BB-TEXT-ADDR ✅ `e9808467`, EM-BB-R10-FIX ✅ `d96d5520`). Baseline: smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty-subsystems PASS=10. |
