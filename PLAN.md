...
| Goal | File | Repo | Step |
|------|------|------|------|
| SNOBOL4 Frontend Ladder | `GOAL-LANG-SNOBOL4.md` | one4all | SN-22d (log expr_eval re-verification — last SN-22 sub-rung; SN-22a/b/c all done, gates green, broker=49) |
