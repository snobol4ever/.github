...
| **Prolog BB JCON triage** | `GOAL-PROLOG-BB-JCON.md` | one4all+corpus+.github | **All Active steps complete** ✅ PJ-7 ✅ (backtracking pump: smoke_prolog 5/5 was 4/5, broker 20/49) and PJ-8 ✅ (5-line stub of _usercall_hook prolog AST branch under SM dispatch). 2026-05-16f: one4all 4e5e1d9a. Next phase per goal-file Done-When: inline x86 emitters for Prolog primitives (mode 4) — open a new goal-step row when starting. |
