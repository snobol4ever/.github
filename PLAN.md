...
| **Snocone sm_lower (M2 path)** | `GOAL-SNOCONE-SM-LOWER.md` | corpus+one4all+.github | **NEXT: SL-13 — blocked on T_2AMP (&) unimplemented in snocone_parse.y. Fix in GOAL-LANG-SNOCONE, then one-line wire: TDump→Lower_collect + Lower_run().** SL-10..SL-12 ✅ sess 2026-05-12 (Claude Sonnet 4.6): lower_pat_expr Ph2, emit_thunk/lower_defer, EVAL(*expr). corpus `e408c87`. |
