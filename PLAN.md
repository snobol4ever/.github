...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: finish SM templates (46 of 99 opcodes still missing from g_sm_templates[] — see watermark list). Then BB templates (EM-TEMPLATE-PURITY).** one4all `f33589d8`: 16 SM template files covering 53 opcodes done. |
