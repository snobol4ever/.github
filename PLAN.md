...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: RW-6 finish** — delete 5 remaining old .c files (emit_insn, emit_form, emit_buf, emit_label, emit_text3c) + emit.c debris; finalize ARCH-EMITTER.md. RW-6 partial ✅ `a6d3ec98` (emit_bb_seq deleted, all new files updated to new names). |
