...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: update ARCH-EMITTER.md then M5** — EM-SNOCONE-PREP ✅ `71244e57`; RW-CONSOLIDATE ✅ `a474db49` (31→11 emitter files). |
