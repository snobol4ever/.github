...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-19-remaining** — ir-run 206. Done this session: every !tbl:=val table+list fix; !str:=ch ICN_ITERATE_FIRST_SET frame-local slot fix; H/I correct in substring. Blocked on CH-17g: scan/string/wordcnt. Non-blocked next: substring J/K/L (subscript-range assign). 7977321b. |
