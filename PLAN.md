...
| **PARSER-RAKU (pattern frontend)** | `GOAL-PARSER-RAKU.md` | corpus+one4all | RK-18 LANDED PASS=95 FAIL=0 corpus@85c4a88 — print+die+DQ escape. Next: RK-19 gather/take or map/grep |
