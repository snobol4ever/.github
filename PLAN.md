...
| Goal | File | Repo | Step |
|------|------|------|------|
| **CHUNKS — Eliminate SM_PUSH_EXPR** | `GOAL-CHUNKS.md` | one4all+.github | **NEXT: CH-17g-irrun-execution**. Prereqs: CH-17g-irrun-prep + CH-17i-table/icn-list-mutators. Icon regression blocks direct attempt. |
...
| **⚡ PREMIER: Mode-3 x86 Emitter** | `GOAL-MODE3-EMIT.md` | one4all+corpus+.github | **✅ CLOSED** — one4all `ff9100cb`. |
| **Icon BB Complete (honest mode 3)** | `GOAL-ICON-BB-COMPLETE.md` | one4all+.github | ⛔ SUPERSEDED by GOAL-ICON-BB-NATIVE. |
| **⚡ Icon BB Native (flat BB templates)** | `GOAL-ICON-BB-NATIVE.md` | one4all+.github | **✅ DONE** — one4all `7efdf09a`. 39 ir-run FAILs remain (see JCON). |
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-11** (IJ-10 ✅ `88db975a`; ir-run 199/36, honest 270). |
| **Prolog BB Complete (honest mode 3)** | `GOAL-PROLOG-BB-COMPLETE.md` | one4all+.github | **✅ COMPLETE** — one4all `c9b7428d`. |
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-RAW-PURGE-1 Phase B** — Phase A done (`10796587`, ⛔ broken). Add patnd_make_xchr/eps, replace 6 NULL stubs in stmt_exec.c, fix bb_build_brokered prologue. Gates must reach smoke 7/7, template-byte-id 4/4. |
| **Snocone SM (M2 path: lower.sc + sm_interp.sc, self-host)** | `GOAL-SNOCONE-SM.md` | corpus+one4all+.github | **NEXT: SI-18** — write `scripts/dump_ir_to_ast_builder.py`. corpus `cee6722`, one4all `185c9832`. |
...
| **✅ sm_lower.c refactor** | `GOAL-SM-LOWER-REFACTOR.md` | one4all+.github | **COMPLETE** — one4all `15cfaa2d`. |
