...
| **⚡ Mode-4 Full Suite: SNOBOL4+Snocone** | `GOAL-MODE4-SN4-SNOCONE.md` | one4all+corpus+.github | **NEXT: M4SN-4** — broad corpus snobol4 sm-run parity in mode-4. M4SN-3b ✅ sess 2026-05-14 (beauty_fence fixed `d965e9ed`): delete flat_is_eligible; xlnth/xtb/xrtb binary paths; bb_in_pool; emit_flat_invariant. Baselines: smoke 7/7, crosscheck_sn4 6/6 ✅, crosscheck_sc 8/8 ✅, gate_em8 5/5 ✅. |
