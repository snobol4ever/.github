...
| **⚡ Universal Generator IR** | `GOAL-LOWER-REDESIGN.md` | one4all+.github | **NEXT: LR-S1b (cont.)** — broad corpus 161/280; remaining: TT_VAR deref in patterns, dynamic-arg patterns, non-pattern bugs. Fixed sess 2026-05-14c: union clobber (+10); ARBNO (+6). renames ✅ `92213ee1`; reorg ✅ `553a836a`; LR-S1b partial `0c84d492` |
