...
| **SCRIP Head Quarters** | `GOAL-HEADQUARTERS.md` | one4all+corpus+(.github) | **PPV-9** EC-UNI-REFAITH: audit remaining STUB cells for any that should be live. Then EC-UNI-REWIRE-ALL path-a/b decision. one4all `3e3b67b1`. GATE-PK PASS=411 FAIL=0 STUB=648. |
