...
| **PARSER-RAKU (pattern frontend)** | `GOAL-PARSER-RAKU.md` | corpus+one4all | PARSER-RK-12 LANDED PASS=65 FAIL=0 corpus@15666e9 — logical && || !. Next: RK-13 — string ~ concat or assignment ops += -= |
