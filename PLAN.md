...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-19-to-by** — implement TT_TO_BY as IR_ICN_TO_BY DCG. Emergency revert done `bb48e6c3`: icn_bb_to+icn_bb_every C BBs deleted, replaced with IR_ICN_TO+IR_ICN_EVERY DCGs. |
...
| **⚡ Mode-4 Full Suite: SNOBOL4+Snocone** | `GOAL-MODE4-SN4-SNOCONE.md` | one4all+corpus+.github | **NEXT: M4SN-4b** — fix 052_pat_arbno variant capture (ARBNO . V) result propagation. Sess 2026-05-14b (`308da7a6`): 118/280. Fixed: emit_flat_xcat 3+child right_β bug; pre_build_children grandchild recursion; XARBN child brokered ABI; rt_bb_arbno magic sentinel. |
