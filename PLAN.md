...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-BB-FORMAT** — ESP-15 ✅ sess 2026-05-13n (Claude Sonnet 4.6): sm_codegen.c split into sm_codegen.c (jit-run binary, 2151 lines) + emitter_sm_gen.c (jit-emit text, 2387 lines). one4all `a87483ab`. Gates: smoke 7/7, byte-id 4/4, em8 5/5. |
