...
| **Icon BB JCON triage** | `GOAL-HEADQUARTERS.md` | one4all+corpus+.github | **NEXT: ST2-1b** — burn down six reader shim macros (label_table/proc_table/pl_pred_table/g_registry/label_count/proc_count) by migrating readers to take `stage2_t *s2` directly.  ST2-1 ✅ at `871d2f0b` (stage2_t baton, g_stage2 global value, SM_sequence_t pure sequence).  Also ISO-4 (scrip_parse subprocess), IR-CD-5/6/7, IR-RN-3/4/5 still open.  Watermark `871d2f0b`. |
