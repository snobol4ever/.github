...
| **Icon BB JCON triage** | `GOAL-HEADQUARTERS.md` | one4all+corpus+.github | **EC-2 ✅ COMPLETE 2026-05-19 (Sonnet 4.6, one4all `0e523e74`) — all 18 BB kinds in emit_bb_node. NEXT: EC-3 (SM instruction template migration).** |
