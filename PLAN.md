...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-5** (IJ-1..IJ-4 ✅ `2e810645`: builtin-as-proc-value f:=sqrt;f(4.0) fixed; ir-run 198, honest 266) |
