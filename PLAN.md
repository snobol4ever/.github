...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-RAW-PURGE-1** — finish removing bb_lit_emit_binary/bb_eps_emit_binary from stmt_exec.c; build clean; commit. one4all partial work at `b0729299` (uncommitted). |
