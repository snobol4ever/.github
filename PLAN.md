...
| **CLI 3-mode collapse + AST-interp delete** | `GOAL-CLI-3MODE.md` | one4all+.github | CLI-3M-1..7 ✅, CLI-3M-10 ✅ (2026-05-17j). **CLI-3M-9 ✅ 2026-05-18 (`9aeede7d`)** — `interp_eval()` + `interp_exec.c` deleted; mode 1 genuinely removed from binary. NEXT: CLI-3M-11 doc pass → CLI-3M-12. |
