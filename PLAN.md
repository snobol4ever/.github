...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-BB-FORMAT** — EM-REORG-1..9 ✅ (sess 2026-05-13s): emit_bb_gen.c fully drained + deleted, 3 files renamed. one4all `71c31336`. Gates: smoke 7/7, byte-id 4/4, em8 5/5. |
