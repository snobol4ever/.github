...
| Snocone Frontend Ladder | `GOAL-LANG-SNOCONE.md` | one4all+corpus | SC-24c IN PROGRESS: SPAN(" " nl) clean carving pattern, no sentinel; ARBNO zero-match open; next: fold cont into spat body, no inner loop; corpus HEAD c336507 | ☐ |
