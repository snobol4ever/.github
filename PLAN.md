...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-19-remaining** — TT_SUSPEND (user proc generators, blocked on CH-17g coroutine prereq); rung32 strretval; rung36 suite. ir-run 192→197 (+5), honest 273, broker 23/49. Fixes: IR_ICN_TO_NESTED (nested-to); trim trailing-only; seq DCG; icn_drive_node in bb_eval_value (accumulation); icn_bb_mutual (A&B cross-product). one4all 53254e3c. |
