...
| **SCRIP Head Quarters** | `GOAL-HEADQUARTERS.md` | one4all+corpus+(.github) | **one4all HEAD=`6abafcb2`**. Session ~21: INLINE-SPLIT-GROUPS ✅, STYLE-BASELINE-COMPRESS ✅, IS_X86-STRUCTURE ✅, STYLE-NO-LOCAL-SHADOWS ✅. EC-UNI ✅. GATE-PK 407/0/647. **NEXT: EMIT-UNIFY EU-1 (audit SM/BB backend coverage) or ISO-4 (scrip_parse subprocess).** |
