...
| **⭐ DYNAMIC BYRD BOX** | DYN-53 | one4all `effd6e9` · corpus `2f2bbe3` | **DYN-54**: fix E_CAPT_COND_ASGN nchildren (continuation captures) → word2–4/cross · scrip-cc prefix fix · target ≥170p |
