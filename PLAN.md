...
| **SCRIP Head Quarters** | `GOAL-HEADQUARTERS.md` | one4all+corpus+(.github) | **EC-UNI-INLINE-ALL NEXT** (Lon directive 2026-05-21 #9: one C template fn per SM/BB, all backend code inline; tables & shims delete). 7 substeps INLINE-1..7. PPV-9 ✅ WASM arms for 9 pat kinds. one4all `794b9435`. GATE-PK PASS=420 FAIL=0 STUB=639. EC-UNI-22 (close/docs) sequenced AFTER INLINE-ALL. |
