...
| **TEXTF: literal emit_textf templates** | `GOAL-TEXTF-TEMPLATES.md` | one4all+.github | G1 ✅ bb_abort/fence/rem/arb. G2 ✅ bb_len/pos/tab. G3 ✅ bb_charset_helper preamble. G4 ✅ bb_lit banner+mov. one4all `1974df8a`. PASS=406 FAIL=0 STUB=653. **NEXT: G5** (compound/recursive: bb_cat/alt/arbno/assign/capture). Beauty gate SUSPENDED. |
