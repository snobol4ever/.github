...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: -m BB XFARB/XEPS/XFAIL.** -l ✅ sm_arith `3b431771`. -k ✅ bb_xposi/xrpsi `30b19814`. -j ✅ sm_jump `cc21cf01`. -i ✅ bb_xbrkx. -h ✅ sm_void_pop. |
