...
| **Snocone-in-Snocone** | `GOAL-SNOCONE-IN-SNOCONE.md`   | one4all+corpus | SS-2a (analyze SCRIP C interp code — read interp.c, identify the ~20 EKind values Snocone emits, confirm the sc_eval dispatch shape, document findings in goal file. Then SS-2 value.sc.) |
