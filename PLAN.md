...
| **PARSER-SNOCONE (pattern frontend)** | `GOAL-PARSER-SNOCONE.md` | corpus+one4all | PARSER-SC-4 (INFRA-3 ✅ session #67: IR-side eval_pat.c E_INDIRECT fix landed; PASS=21 FAIL=0) |
