...
| **⭐ DYNAMIC BYRD BOX** | DYN-47 | one4all `c15de9f` · corpus `2f2bbe3` | **DYN-48**: MONITOR diff scrip-interp vs SPITBOL on regressed tests → fix broad 126p/52f → 169p/9f. Then M-PARSE-1: parse.y. |
