...
| **BB Template Ladder — Icon + Prolog** | `GOAL-BB-TEMPLATE-LADDER.md` | one4all+corpus+.github | ICN-T-2 ✅. Phase F done: F-6a/b/c ✅, F-6d partial `bd6b0917`. GOLDEN BB RULE: BB_t is SCRIP's sole IR (≡ JCON ir_* records); sval/ival/dval=IR payload; c[]/n/sval2/ival2/ival3/opaque deleted from struct. BB.h updated, build fails at emit_core.c:913. **NEXT: G-1** — migrate all c[]/n callers to port walks. Rungs 153. |
