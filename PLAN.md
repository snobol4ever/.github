...
| Prolog Frontend Ladder | `GOAL-LANG-PROLOG.md` | one4all+corpus | **PR-19c LANDED** → PR-19d (2026-05-02: call/N arm added to pl_runtime.c + pl_broker.c routing fix. rung33_bridge_callN PASS=5/5. All gates: smoke 5/5, broker 49/49, rung31-33 5/5 each. **Next: PR-19d** — rung34_bridge_setof/ for setof/3, bagof/3, findall/3 with goal-as-Var.) |
