...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-BB-FORMAT** — EM-RAW-PURGE-1 ✅ `46642b16`. Each BB port = one 4-col GAS line; no if-stmts in template fns. Gates: smoke 7/7, template-byte-id 4/4, snocone 5/5, gcc -c clean, beauty ≥10. |
