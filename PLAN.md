...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: fix XDSAR brokered segfault (ShiftReduce/trace)** — beauty PASS=12/17; RW-BREAKS-FIX ✅ `98a93700`; ARCH-EMITTER updated; mode4 test drive: 3 bugs fixed (UNHANDLED int, Δ sym, loop early-exit), bb_emit_mode default fixed `e61819e5`. |
