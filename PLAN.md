...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EM-BB-FORMAT** — sess 2026-05-13q: emit_sm_gen.c dropped + 16-file comment strip (11315→9449 lines). one4all `1fc4490c`. Gates: smoke 7/7, byte-id 4/4, em8 5/5. |
