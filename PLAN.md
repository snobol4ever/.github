...
| **⚡ Universal Generator IR (gen_node_t)** | `GOAL-LOWER-REDESIGN.md` | one4all+.github | **NEXT: LR-0** — define gen_node_t/gen_cfg_t; replaces GOAL-ICON-LOWER-REDESIGN; covers Icon+SNOBOL4 patterns+Prolog |
