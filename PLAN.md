...
| **⚡ Icon BB Native (flat BB templates)** | `GOAL-ICON-BB-NATIVE.md` | one4all+.github | **✅ GOAL DONE. Session 2026-05-12 (Claude Sonnet 4.6, one4all `6d48bff0`): 6 commits, ir-run 180→195, honest 215→259. SM_BB_EVAL for TT_ALTERNATE/TO/ITERATE/BANG_BINARY value context (GC-safe every_table); SM_STORE_FRAME FAILDESCR propagation; new builtins open/read/close/IDENTICAL/set. 40 ir-run FAILs remain (statics, augop-in-IDX, scan partial output, missing builtins).** |
...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EDP-10 — Delete heap ζ struct typedefs and `bb_<kind>_new()` constructors** (EDP-6/7/8/9 ✅ `21b7518a`). Baseline: smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty-subsystems PASS=11. |
