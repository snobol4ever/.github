...
| Goal | File | Step |
|------|------|------|
| **ICON-BB** | `GOAL-ICON-BB.md` | LFJ-0 ✅ (`bc7dae2a`). LFJ-1a-i ✅ (`f79ea9ba`: 9 leaf cases). **LFJ-1a-ii** ✅ (`013703ff`: 6 cases extracted — TT_SCAN/TT_ASSIGN/TT_SWAP/TT_FNC/TT_SEQ_EXPR/TT_SEQ → lower_icn_legacy_<KIND> static fns; switch arms collapsed; ZERO logic change). Next: **LFJ-1a-iii** — extract TT_IF, TT_TO, TT_TO_BY, TT_EVERY, TT_WHILE, TT_UNTIL, TT_REPEAT, TT_LIMIT. Gates: smoke 5/5, broker 24, rungs 198, smoke_prolog 5/5. |
