...
| Icon Frontend Ladder | `GOAL-LANG-ICON.md` | one4all | IC-2a wire-up next: icn_bb_binop_gen+icn_bb_alternate into icn_eval_gen; E_AUGOP gen RHS; boxes written HEAD 19eccadf | ☐ |
