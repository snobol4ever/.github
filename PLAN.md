...
| **⚡ Universal Generator IR** | `GOAL-LOWER-REDESIGN.md` | one4all+.github | **NEXT: LR-0** — ir_node_t/gen_cfg_t; SM+BB two-land pipeline; all 6 languages; DCG; SM_EXEC_GEN replaces SM_BB_EVAL; Rebus test bed first |
