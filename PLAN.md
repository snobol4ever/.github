...
| **⚡ Mode-4 Full Suite: SNOBOL4+Snocone** | `GOAL-MODE4-SN4-SNOCONE.md` | one4all+corpus+.github | **NEXT: M4SN-4b continued** — differ/DIFFER ingress fix; broad corpus 189/280. M4SN-2 ✅ `15d28f85`; interp_call ufname case fix ✅ `68a77cf0`. |
