...
| **⚡ PST: Snocone** | `GOAL-PST-SNOCONE.md` | one4all+corpus+.github | **⏳ Phase 1 NOT clean** per `PST-LR-AUDIT.md § Scan 1` — 11 §⛔ violations. Closed rungs 4a–4j ✅. Active: **PST-SC-4k** (`goto LABEL` → `TT_GOTO_U`); 4l/4m/4n; PST-SC-FLATTEN, PST-SC-LABELS, PST-SC-RET-IN-FN, PST-SC-FOR-INIT (audit-promoted). |
