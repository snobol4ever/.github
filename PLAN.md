...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-19-remaining** — TT_SUSPEND (blocked CH-17g); rung36 suite. ir-run 200→201 (+1), honest 273, broker 23/49. Fix: IJ-19-fail: fail keyword in proc bodies (SM_BB_EVAL FRAME.returning + sm_call_expression kw_rtntype). roman ✅. one4all 992a2a18. |
