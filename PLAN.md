...
| **⭐ DYNAMIC BYRD BOX** | DYN-54 | one4all `f7e9be0` · corpus `2f2bbe3` | **DYN-55**: fix E_ARB/E_CAPT_COND_ASGN returning DT_S not DT_P in interp_eval → word2/3/4/wordcount/cross → ≥159p |
