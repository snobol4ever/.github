...
| **⭐ DYNAMIC BYRD BOX** | DYN-25 | one4all `200543f` · .github (this) · corpus `d5058ef` | **DYN-26**: M-INTERP-A02 — wire E_CAPT_*/E_ALT in interp_eval → pat_* constructors → broad ≥85p. See SESSION-dynamic-byrd-box.md §M-INTERP-A02. |
