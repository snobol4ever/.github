...
| **Icon BB JCON triage (39 FAILs + rung37 tests)** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-1 — alternate filter in every** |
...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EC-2 — Group extern declarations at top of `bb_templates.c`** (EC-1 ✅ `3ec4fcec`: zero C BB calls — all templates use rt_bb_* or inline x86). Baseline: smoke 7/7, template-byte-id 4/4, snocone 5/5, beauty-subsystems PASS=10. |
