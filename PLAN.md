...
| Snocone Frontend Ladder | `GOAL-LANG-SNOCONE.md` | one4all+corpus | SC-24c DONE: TRIM fix claws5.sno zero diff vs ref; SC-26 next: fix (PAT.var).*fn(var) eval order; corpus HEAD 0d13092 | ☐ |
