...
| **Icon BB JCON triage** | `GOAL-ICON-BB-JCON.md` | one4all+corpus+.github | **NEXT: IJ-BB-3 Group G lower_fnc sval guard** (Groups A-E,H ✅; BB-2 ✅ `601af0e0`; CORO cleanup ✅ `dfb2497c`; ir-run 192, honest 273) |
...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: SF-8** — SF-7 ✅ dead `emit_bb_stateful_int` deleted; BREAKX binary path uses direct `emit_seq_port_call` (like BAL/ARB/REM). SF-6 ✅ `8a63e515` ICN_* boxes sized DATA blocks. SF-5 ✅ `55857945` BREAKX flat. SF-4 ✅ `98b2e204` LEN/TAB/RTAB. SF-3 ✅ REM. SF-2 ✅ ARB. SF-1 ✅. S200 done. beauty 10/17. New section: EM-ICN-FLAT (IF-0..IF-6) added — convert all 44 ICN_* RTCALL boxes to flat. |
