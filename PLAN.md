...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **REOPENED — NEXT: EM-MODE4-IS-MODE3-DUMP-b** (vtable skeleton).  Sub-rung -a ✅ sess 2026-05-11 (Claude Opus 4.7): pivot from "SEG_CODE disassembly" to "one C template per opcode + emit_v vtable with binary/text/macro_def backends"; design doc `one4all/MIGRATION-MODE4-IS-MODE3-DUMP.md`; rung header + sub-rung list amended.  Tripwire: test_gate_em_beauty_subsystems_mode4 PASS=4 FAIL=13 frozen at handoff. |
