...
| **Mode-4 x86 Emitter** | `GOAL-MODE4-EMIT.md` | one4all+corpus+.github | **NEXT: EDP-5 — bb_flat.c flat_emit_* helpers folded into templates** (EDP-4 ✅ `9f4307c1`). Baseline: smoke 7/7, template-byte-id 4/4, snocone 5/5. |
